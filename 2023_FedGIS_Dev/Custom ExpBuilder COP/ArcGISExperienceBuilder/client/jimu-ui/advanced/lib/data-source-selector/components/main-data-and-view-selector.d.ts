...
/** @jsx jsx */
import { React, ImmutableArray, UseDataSource, IMUseDataSource, IntlShape, jsx, BrowserSizeMode, ReactRedux } from 'jimu-core';
...
export declare const MainDataAndViewSelector: React.FC<import("react-intl").WithIntlProps<Omit<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "browserSizeMode"> & MainDataAndViewSelectorProps & ReactRedux.ConnectProps>> & {
    WrappedComponent: React.ComponentType<Omit<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "browserSizeMode"> & MainDataAndViewSelectorProps & ReactRedux.ConnectProps>;
};
export {};
