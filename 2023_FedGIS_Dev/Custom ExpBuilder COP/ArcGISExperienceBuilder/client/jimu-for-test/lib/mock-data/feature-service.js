    ...
    layers: [
        {
            ...
            layerDefinition: Object.assign(Object.assign({}, featureLayer.layerDefinition), { id: 1, name: 'Incidents' })
        },
        {
            url: `${FEATURE_SERVICE_URL}/2`,
            layerDefinition: Object.assign(Object.assign({}, featureLayer.layerDefinition), { id: 2, name: 'SF_Crime_Incidents' })
        }
    ]
};
