...
export declare function publishResignInFlagsChangeToBuilder(): void;
...
export declare function publishPortalUrlNeedToRegisterClientId(portalUrl: string, needToSignIn: string, serviceUrl?: string): void;
