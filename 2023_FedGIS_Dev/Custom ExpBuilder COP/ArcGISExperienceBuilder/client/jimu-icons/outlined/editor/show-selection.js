...
export const ShowSelectionOutlined = (props) => {
    ...
    return React.createElement(SVG, Object.assign({ className: classes, src: src, srcRTL: srcRTL }, others));
};
//# sourceMappingURL=show-selection.js.map