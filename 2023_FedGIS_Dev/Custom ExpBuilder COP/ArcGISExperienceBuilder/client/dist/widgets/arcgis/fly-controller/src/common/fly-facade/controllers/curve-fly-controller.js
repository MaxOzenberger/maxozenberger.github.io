...
export default class CurveFlyController extends BaseFlyController {
    constructor() {
        super(...arguments);
        this._updateInitCamera = (line) => {
            line = this.queryGeometryElevInfo(line);
        ...
        //   return cameraRoutes;
        // }
        this.getCameraPosition = (basePos, nextPos) => {
            var _a, _b;
            if (basePos[0] === nextPos[0] && basePos[1] === nextPos[1] && basePos[2] === nextPos[2]) {
                return null;
            }
            const cameraHeight = (_a = this.liveviewSetting.getCamOffsetHeight()) !== null && _a !== void 0 ? _a : 100; // metre
            const fixDistance = (_b = this.liveviewSetting.getCamOffsetDistance()) !== null && _b !== void 0 ? _b : 100; // metre
            ...
            const vecLen = this.vec3.length(vecDir);
        ...
        this.resumeCamera = (animate) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.sceneView.goTo(this.getApiCamera(this.getCameraByProgress()), { animate: useAnimate, signal: this.abortSignalHandler.update() });
            }
            catch (error) {
    ...
    setLiveviewSettingInfo(paramObj) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.setLiveviewSettingInfo.call(this, paramObj, () => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    yield this.sceneView.goTo(apiCam, { animate: false, signal: this.abortSignalHandler.update() });
                }
                catch (error) {
                    if (error.name === 'AbortError') {
                        console.log('sceneView.goTo() Aborted');
  ...
  ////////////////////////////////////////
    ...
    prepare(opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((line === null || line === void 0 ? void 0 : line.type) !== 'polyline') {
                alert('Wrong geo type!');
                return false;
            }
            if (utils.isDefined(opts === null || opts === void 0 ? void 0 : opts.duration)) {
            ...
            if (!this.isLiveviewMode) {
                ...
                this.animate.init(EasingMode.Linear, 0, this.animate.getAmount(), (_a = this.duration) !== null && _a !== void 0 ? _a : d);
            }
            if (this._isDebug) {
            ...
            try {
                yield this.sceneView.goTo(this.getApiCamera(this.getCameraByProgress()), this.getPrepareGoToOptionsBeforeTerrainLoaded(opts));
            }
            catch (error) {
                if (error.name === 'AbortError') {
                    console.log('sceneView.goTo() Aborted');
            ...
            if (opts === null || opts === void 0 ? void 0 : opts.waittingForTerrain) {
                ...
                try {
                    yield this.sceneView.goTo(this.getApiCamera(this.getCameraByProgress()), this.getPrepareGoToOptionsAfterTerrainLoaded(opts));
                }
                catch (error) {
                    if (error.name === 'AbortError') {
                        console.log('sceneView.goTo() Aborted');
    ...
    fly(opts) {
        const _super = Object.create(null, {
            isEnableToFly: { get: () => super.isEnableToFly }
        });
        return __awaiter(this, void 0, void 0, function* () {
            if (utils.isDefined(opts === null || opts === void 0 ? void 0 : opts.speedFactor)) {
                this.liveviewSetting.setSpeedFactor(opts.speedFactor);
            }
            if (_super.isEnableToFly.call(this)) {
                return yield this.resume(opts.animate);
            }
            else {
...
//# sourceMappingURL=curve-fly-controller.js.map