...
export default class Bspline {
    constructor(points, iterF) {
        this.points = points !== null && points !== void 0 ? points : [];
        this.points = this.normalPoints4Bspline(this.points);
        this.iter = iterF !== null && iterF !== void 0 ? iterF : 3;
    }
    getSpline() {
    ...
    normalPoints4Bspline(rawPoints) {
        ...
        for (let i = 0, len = rawPoints.length; i < len; i++) {
            ...
            const x = p[0];
            const y = p[1];
            const z = (_a = p[2]) !== null && _a !== void 0 ? _a : 0;
    ...
    bspline(pts, iterations) {
        ...
        const controlPoint1 = 0.2;
        const controlPoint2 = 0.8;
