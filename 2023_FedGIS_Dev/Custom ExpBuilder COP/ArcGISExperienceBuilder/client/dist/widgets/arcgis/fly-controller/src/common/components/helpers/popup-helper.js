...
export default class PopupHelper extends React.PureComponent {
    constructor(props) {
        super(props);
        ...
        // cache&restore
        this.cacheMapPopupHightlightState = () => {
            var _a, _b;
            this.mapPopupState.popup = (_a = this.props.jimuMapView) === null || _a === void 0 ? void 0 : _a.isClickOpenPopupEnabled();
            this.mapPopupState.hightLight = (_b = this.props.jimuMapView) === null || _b === void 0 ? void 0 : _b.isClickHighlightEnabled();
        };
        this.restoreMapPopupHightlightState = () => {
            const jimuMapView = this.props.jimuMapView;
...
//# sourceMappingURL=popup-helper.js.map