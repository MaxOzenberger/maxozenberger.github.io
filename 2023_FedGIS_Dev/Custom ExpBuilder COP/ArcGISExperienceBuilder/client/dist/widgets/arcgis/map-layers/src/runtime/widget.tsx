...
export default class Widget extends React.PureComponent<WidgetProps, WidgetState> {
  ...
  registerLayerListActions () {
    this.layerListActions = [
      ...
      new Label(this,
        this.props.intl.formatMessage({ id: 'showLabels', defaultMessage: defaultMessages.showLabels }),
        this.props.intl.formatMessage({ id: 'hideLabels', defaultMessage: defaultMessages.hideLabels })),
