import {
  React, classNames, MessageManager, ImmutableArray, Immutable, observeStore, ReactResizeDetector,
  getAppStore, appActions, MutableStoreManager, ExtentChangeMessage, UseDataSource, ImmutableObject, JimuMapViewInfo
} from 'jimu-core'
    ...
    return (
      ...
      >
        ...
        {this.props.isDefaultMap && <div className='w-100 h-100 default-map-container' style={{ position: 'relative' }}>
          <div
            className={classNames('w-100 h-100 multisourcemap-item-appear-noanimate default-map')}
