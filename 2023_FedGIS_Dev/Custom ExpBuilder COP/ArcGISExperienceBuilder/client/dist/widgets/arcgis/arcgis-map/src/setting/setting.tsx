...
import {
  ...
  css, jsx, DataSourceManager, getAppStore, polished, classNames, UseDataSource, AllDataSourceTypes
} from 'jimu-core'
          ...
          <SettingRow>
            <div className='w-100 webmap-tools'>
              <div className='webmap-tools-item'>
                <label><FormattedMessage id='featureSelectionColor' defaultMessage={defaultMessages.featureSelectionColor} /></label>
              </div>
              <div className='webmap-tools-item pl-4'>
                <label><FormattedMessage id='featureHighlightFill' defaultMessage={defaultMessages.featureHighlightFill} /></label>
                <div>
                  <ColorPicker
              ...
              <div className='webmap-tools-item pl-4'>
                <label><FormattedMessage id='featureHighlightOutline' defaultMessage={defaultMessages.featureHighlightOutline} /></label>
                <div>
                  <ColorPicker
                    style={{ padding: '0' }} width={26} height={14}
              ...
              <div className='webmap-tools-item'>
                <label><FormattedMessage id='enableScrollZoom' defaultMessage={defaultMessages.enableScrollZoom} /></label>
                <Switch
              ...
              <div className='webmap-tools-item'>
                <span className='text-break' style={{ width: '80%' }}><FormattedMessage id='enablePopUp' defaultMessage={defaultMessages.enablePopUp} /></span>
                <Switch
                  className='can-x-switch' checked={(this.props.config && this.props.config.disablePopUp !== true) /* eslint-disable-line */}
