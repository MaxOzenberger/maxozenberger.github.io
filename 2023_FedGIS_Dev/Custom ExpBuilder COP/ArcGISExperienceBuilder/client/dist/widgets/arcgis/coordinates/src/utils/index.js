 ...
 */
export const degToDMS = (decDeg, decDir, decimal, showSeparators) => {
...
export const degToDDM = (decDeg, decimal, showSeparators) => {
    let d = Math.abs(decDeg);
    let deg = Math.floor(d);
    d = d - deg;
    let min = Math.floor(d * 60);
...
export const localizeNumberBySettingInfo = (num, settingInfo) => {
 ...
 * @param {any} crs
 */
export const getCSUnitByCrs = (crs) => {
    var _a, _b;
 ...
 */
export const getUnitRate = (defaultUnit, outputUnit, mapIsMercator) => {
