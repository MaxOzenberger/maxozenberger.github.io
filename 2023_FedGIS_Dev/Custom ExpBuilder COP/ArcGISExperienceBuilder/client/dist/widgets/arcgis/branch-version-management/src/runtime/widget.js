...
import { BaseWidget, jsx, DataSourceManager, css, lodash, Immutable, defaultMessages as jimuCoreMessages, getAppStore, SessionManager, urlUtils, DataSourceTypes, DataSourceComponent } from 'jimu-core';
import { Button, Input, ListGroup, Icon, InputGroup, Modal, ModalHeader, ModalBody, ModalFooter, Popper, Checkbox, Col, FormGroup, Label, Alert, Select, Table, Pagination, TextInput, TextArea, Tooltip, Switch, defaultMessages as jimuUIDefaultMessages, maxSizeModifier, applyMaxSizeModifier, getCustomFlipModifier, WidgetPlaceholder } from 'jimu-ui';
...
export default class Widget extends BaseWidget {
    constructor(props) {
        ...
        this.widRefForPopper = this.props.widgetId + 'divSimpleContainer';
        this.delayClickPrevent = new Date().getTime();
        this._populateSwitchableSources = (status) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.renderServiceSelector = () => {
            ...
            if (configObj !== null) {
                configObj.services.forEach((s) => {
                    services.push(jsx("option", { key: s.name, value: s.name }, s.name));
                    if (this.state.selectedService !== '') {
            ...
            if (serviceObj !== null) {
                ...
                const editFilter = allowanceList.filter((al) => {
                    return al.key.search(/\bDelete|\bUpdate|\bChange/g) > -1;
                });
                canEdit = editFilter.some((eF) => {
            ...
            let renderObject = (jsx("div", { style: {
                    display: 'flex',
                    flex: 1,
                    flexDirection: 'column',
                    height: '96%'
                } },
                jsx("div", { style: { display: 'flex' } }, services.length > 0
                    ? (jsx("table", { style: { width: '100%' } },
                        jsx("tbody", null, this._createActiveRows(canEdit))))
                    : (this.formatMessage('actionLabelsNoServices'))),
                this.state.isModeExpand && (jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                    jsx("div", { style: {
                            display: 'flex',
                            flex: 1,
                            fontWeight: 'bold',
                            ...
                            paddingTop: 5,
                            paddingBottom: 5
                        } }, services.length > 1 ? (jsx(Select, { value: defaultVal, onChange: (evt) => {
                            this.setState({
                        ...
                        ? (jsx("h6", { style: { fontSize: 'large' } }, configObj.services[0].name))
                        : ('')))),
            ...
            if (this.state.isSimpleMode) {
                if (this.state.isModeExpand) {
                    if (services.length > 0) {
                        renderObject = (jsx("div", { style: {
                                display: 'flex',
                                flex: 1,
                                flexDirection: 'column',
                                margin: 0
                            } },
                            jsx("div", { className: "simple-view-header-bgcolor display-flex-row-1 cursor-hand", onClick: (evt) => {
                                ...
                                jsx("div", { style: {
                                    ...
                                    ? (this.state.selectedVersion.isLocked
                                        ? (jsx(Icon, { icon: lockIcon, size: "15", color: theme.colors.light }))
                                        : (jsx("div", { style: { width: 15, height: 15 } })))
                                    : (jsx("div", { style: { width: 15, height: 15 } }))),
                                jsx("div", { className: "flex-center", style: {
                                        paddingLeft: 5,
                                        paddingRight: 5,
                                        fontWeight: 'bold',
                                        fontSize: 'medium'
                                ...
                                jsx("div", { style: { float: 'right' } },
                                    jsx(Tooltip, { title: this.formatMessage('tooltipsCollapseSimpleMode'), placement: "bottom" },
                                        jsx(Button, { icon: true, onClick: (evt) => {
                                                this.setState({
                                                    isModeExpand: !this.state.isModeExpand
                                                });
                                            } },
                                            jsx(Icon, { icon: upArrowIcon, size: "16", color: theme.colors.primary }))))),
                            jsx(Popper, { open: isOpen ? this.state.isModeExpand : false, floating: false, keepMount: true, reference: this.widRefForPopper, placement: 'bottom', showArrow: true, zIndex: 2001, modifiers: modifiers },
                                jsx("div", { style: { display: 'flex', flexDirection: 'row', margin: 5 } },
                                    jsx("div", { style: { display: 'flex', flex: 1, fontWeight: 'bold' } }, services.length > 1
                                        ? (jsx(Select, { value: defaultVal, menuProps: menuProps, placeholder: this.formatMessage('placeholderSelectService'), onChange: (evt) => {
                                                this.setState({
                                                    selectedService: evt.currentTarget.value,
                                                    selectedVersion: '',
                                                    currentDisplayIndex: 0
                        ...
                        renderObject = (jsx("div", { style: {
                            ...
                            jsx("div", { className: "simple-view-header-bgcolor display-flex-row-1 cursor-hand", onClick: (evt) => {
                                ...
                                jsx("div", { style: {
                                        ...
                                        alignItems: 'center',
                                        display: 'flex'
                                    } }, this.state.selectedVersion != "" ? (jsx(Tooltip, { title: this.formatMessage('tooltipsExpandSimpleMode'), placement: "bottom" },
                                    jsx(Button, { icon: true, onClick: (evt) => {
                                            this.setState({
                                                isModeExpand: !this.state.isModeExpand
                                            });
                                        } },
                                        jsx(Icon, { icon: downArrowIcon, size: "16", color: theme.colors.primary })))) : ('')))));
                    }
                    else {
                        renderObject = (jsx("div", { style: {
                                display: 'flex',
        ...
        this.renderVersionManagement = () => {
            ...
            if (configObj !== null) {
                ...
                const createFilter = allowanceList.filter((al) => {
                ...
                const switchFilter = allowanceList.filter((al) => {
                ...
                if (fieldList.length > 0) {
                    const fieldsDefined = fieldList.filter((lf) => {
            ...
            return (jsx("div", { style: {
                ...
                jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                    validToken
                        ? canCreate
                            ? this.state.showMgmtTools && (jsx("div", { style: { flex: 1, flexDirection: 'row' } },
                                jsx(Tooltip, { title: this.formatMessage('tooltipsNewVersion'), placement: "bottom" },
                                    jsx(Button, { icon: true, onClick: (evt) => {
                                            this.resetVersionObjectData();
                                        }, type: 'primary' },
                                        jsx(Icon, { icon: newVersionIcon, size: "18", color: theme.colors.light })))))
                            : ''
                        : '',
                    validToken && canCreate && jsx("div", { style: { width: '1%' } }),
                    jsx("div", { style: { flex: 1, flexDirection: 'row' } },
                        jsx(Tooltip, { title: this.formatMessage('tooltipsRefreshList'), placement: "bottom" },
                            jsx(Button, { icon: true, onClick: () => {
                                    this.pullVersions(this.state.selectedService, false).then(() => {
                                        if (this.state.searchVersionValue !== '') {
                                            this.searchVersions(this.state.searchVersionValue);
                                        }
                                ...
                                jsx(Icon, { icon: refreshIcon, size: "18", color: theme.colors.dark })))),
                    jsx("div", { style: { width: '1%' } }),
                    jsx(InputGroup, null,
                        jsx(TextInput, { type: "text", placeholder: this.formatMessage('placeholderSearchName'), value: this.state.searchVersionValue, onChange: (evt) => this.searchVersions(evt.currentTarget.value), style: { display: 'flex', flex: 1 } })),
                    showFieldsBtn && jsx("div", { style: { width: '1%' } }),
                    showFieldsBtn && (jsx("div", { style: { flex: 1, flexDirection: 'row' } },
                        jsx(Tooltip, { title: this.formatMessage('tooltipsShowHideColumns'), placement: "bottom" },
                            jsx(Button, { id: this.props.widgetId + '_btnFieldMgmt', icon: true, onClick: () => {
                                    this.toggleDialogAction('fieldMgmt', 'showFieldMgmt');
                                } },
                                jsx(Icon, { icon: addFieldIcon, size: "18", color: theme.colors.dark })))))),
                jsx("div", { style: {
                        display: 'flex',
                        flex: 2,
                        flexDirection: 'row',
                    ...
                    jsx("div", { style: { display: 'flex', flex: 1, overflow: 'auto' } },
                        jsx(Table, null,
                            this._createVersionHeader(canEdit, canSwitch),
                            jsx("tbody", null, this.state.filteredVersionList.length > 0
                                ? (this._createVersionRows(canEdit, canSwitch))
                                : this.state.searchVersionValue !== ''
                                    ? (jsx("tr", null,
                                        jsx("td", { colSpan: 99 }, this.formatMessage('actionLabelsNoVersions'))))
                ...
                jsx("div", { style: {
                    ...
                    this.state.filteredVersionList.length > 1 && (jsx("div", { style: { display: 'flex', flex: 1, justifyContent: 'flex-start' } },
                        jsx(Pagination, { className: "mb-3", size: "lg", totalPage: this.state.filteredVersionList.length, current: this.state.currentDisplayIndex + 1, onChangePage: (evt) => {
                    ...
                    jsx("div", { style: {
                            display: 'flex',
                            flex: 1,
                            justifyContent: this.state.filteredVersionList.length > 1
                                ? 'flex-end'
                                : 'flex-start',
                            fontSize: 'small'
                        } },
        ...
        this.renderVersionManagementSimple = () => {
            ...
            return (jsx("div", { style: {
                ...
                jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                    ...
                    jsx(InputGroup, null,
                        jsx(TextInput, { type: "text", placeholder: this.formatMessage('placeholderSearchName'), value: this.state.searchVersionValue, onChange: (evt) => this.searchVersions(evt.currentTarget.value), style: { display: 'flex', flex: 1 } }))),
                jsx("div", { style: { paddingTop: 5, display: 'flex', flexDirection: 'row' } },
                    jsx("table", { style: { fontSize: 'medium', paddingTop: 5, width: '100%' } },
                        jsx("tbody", null, this.state.filteredVersionList.length > 0
                ...
                jsx("div", { style: {
                    ...
                    this.state.filteredVersionList.length > 1 && (jsx("div", { style: { display: 'flex', flex: 1, justifyContent: 'flex-start' } },
                        jsx(Pagination, { className: "mb-3", size: "sm", totalPage: this.state.filteredVersionList.length, current: this.state.currentDisplayIndex + 1, onChangePage: (evt) => {
                                this.setState({ currentDisplayIndex: evt - 1 }, () => {
                                    this._checkStatus();
                                });
                            } }))),
                    jsx("div", { style: {
                        ...
                        jsx("div", { style: { display: 'flex', flex: 1, justifyContent: 'flex-start', flexDirection: 'column' } },
                            jsx("div", null,
                                this.formatMessage('placeholderLastUpdated'),
                                ' ',
                                this.state.timeStamp),
        ...
        this._createVersionHeader = (canEdit, canSwitch) => {
            ...
            if (!validToken) {
                localFields = localFields.filter((lf) => {
                    return lf.field === 'versionName' || lf.field === 'versionOwner';
                });
            }
            localFields.sort(this._compare('order', 'desc'));
            localFields.forEach((fld) => {
                if (fld.show) {
                    headerList.push(jsx("th", { key: fld.field, style: {
                            position: 'sticky',
                            top: 0,
                        ...
                        fld.alias,
                        jsx(Tooltip, { title: fld.sort === 'desc'
                                ...
                                : this.formatMessage('tooltipsSortColumns') +
                                    ...
                                    fld.alias +
                                    ' ' +
                                    this.formatMessage('tooltipsAsc'), placement: "bottom" },
                            jsx(Button, { type: "tertiary", icon: true, onClick: () => {
                                    this.sortVersions(fld.field, fld.sort === 'desc' ? 'asc' : 'desc');
                                } },
                                jsx(Icon, { icon: fld.sort === 'desc' ? sortDownIcon : sortUpIcon, size: "15", color: theme.colors.dark })))));
                }
            });
                ...
                jsx("tr", null,
                    canEdit || canSwitch
                        ? (jsx("th", { style: {
                            ...
                            jsx(Button, { type: "tertiary", icon: true })))
                        : (jsx("th", { style: {
                                position: 'sticky',
                                top: 0,
                                backgroundColor: theme.colors.palette.light[200],
        ...
        this._createActiveRows = (canEdit) => {
            const { theme } = this.props;
            const versionList = [];
            let validToken = true;
            const configObj = this._getConfigServiceObject();
            ...
            const generateRows = (v) => {
                if (typeof v !== 'undefined') {
                    const nameStrip = v.versionName;
                    versionList.push(jsx("tr", { key: v.versionName, className: "simple-view-header-bgcolor cursor-hand", onClick: (evt) => {
                            this.setState({ isModeExpand: !this.state.isModeExpand });
                        } },
                        jsx("td", { style: { paddingLeft: '1rem' } },
                            jsx("div", { style: { display: 'flex', flexDirection: 'row', flex: 1 } },
                                jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                                    jsx("div", { style: { alignItems: 'center', display: 'flex' } }, v.hasOwnProperty('isLocked')
                                        ? (v.isLocked
                                            ? (jsx(Icon, { icon: lockIcon, size: "15", color: theme.colors.light }))
                                            : (jsx("div", { style: { width: 15, height: 15 } })))
                                        : (jsx("div", { style: { width: 15, height: 15 } }))),
                                            ...
                                            ? (v.isLocked === false
                                                ? (canEdit
                                                    ? (v.versionName.toLowerCase() !== 'sde.default'
                                                        ? (jsx("div", { style: { paddingLeft: 5 } },
                                                            jsx(Tooltip, { title: this.formatMessage('tooltipsUpdateVersionInfo'), placement: "bottom" },
                                                                jsx(Button, { icon: true, onClick: (evt) => {
                                                                        evt.stopPropagation();
                                                                    ...
                                                                    jsx(Icon, { icon: editIcon, size: "16", color: theme.colors.dark })))))
                                                        : (jsx("div", { style: {
                                                                display: 'flex',
                                                                flex: 1,
                                                                flexDirection: 'row',
                                ...
                                jsx("div", { style: {
                                    ...
                                    jsx(Button, { icon: true, onClick: (evt) => {
                                        ...
                                        jsx(Icon, { icon: this.state.isModeExpand
                                                ? upArrowIcon
                                                : downArrowIcon, size: "16", color: theme.colors.primary })))) : (''))))));
                }
            };
        ...
        this._createVersionRows = (canEdit, canSwitch) => {
            ...
            const generateRows = (v) => {
                if (typeof v !== 'undefined') {
                    const isActive = v.versionGuid === this.state.selectedVersion.versionGuid;
                    const fieldsList = [];
                    let localFields = [...this.state.fieldColumns];
                    if (!validToken) {
                        localFields = localFields.filter((lf) => {
                    ...
                    localFields.sort(this._compare('order', 'desc'));
                    localFields.forEach((fld, i) => {
                        if (fld.show) {
                            if (fld.field === 'versionName') {
                                const nameStrip = v.versionName.substring(v.versionName.lastIndexOf('.') + 1, v.versionName.length);
                                fieldsList.push(jsx("td", { key: nameStrip + i, className: isActive
                                        ? 'color-primary-small-font td-middle'
                                        : 'color-dark-small-font td-middle', style: { fontSize: 'medium', wordBreak: 'break-all' } }, nameStrip));
                            }
                            else if (fld.field === 'versionOwner') {
                                const owner = v.versionName.substring(0, v.versionName.lastIndexOf('.'));
                                fieldsList.push(jsx("td", { key: owner + i, className: isActive
                                        ? 'color-primary-small-font td-middle'
                                        : 'color-dark-small-font td-middle', style: { fontSize: 'medium' } }, owner));
                            }
                            else if (fld.field.indexOf('Date') > -1) {
                                const formattedDate = new Date(v[fld.field]).toLocaleString();
                                fieldsList.push(jsx("td", { key: formattedDate.toLocaleString() + i, className: isActive
                                        ? 'color-primary-small-font td-middle'
                                        : 'color-dark-small-font td-middle', style: { fontSize: 'medium' } }, formattedDate.toLocaleString()));
                            }
                            else {
                                fieldsList.push(jsx("td", { key: fld.field + i, className: isActive
                                        ? 'color-primary-small-font td-middle'
                                        : 'color-dark-small-font td-middle', style: { fontSize: 'medium' } }, v[fld.field]));
                            }
                        }
                    });
                    versionList.push(jsx("tr", { key: v.versionName },
                        jsx("td", { style: { fontSize: 'medium', verticalAlign: 'middle' } },
                            jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                                jsx("div", { style: { alignItems: 'center', display: 'flex' } }, v.hasOwnProperty('isLocked')
                                    ? (v.isLocked
                                        ? (jsx(Icon, { icon: lockIcon, size: "15", color: theme.colors.dark }))
                                        : (jsx("div", { style: { width: 15, height: 15 } })))
                                    : (jsx("div", { style: { width: 15, height: 15 } }))),
                                canSwitch
                                    ? (jsx("div", { style: {
                                        ...
                                        jsx(Tooltip, { title: isActive
                                                ? this.formatMessage('tooltipsCurrentVersion')
                                                : this.formatMessage('tooltipsSwitchVersion'), placement: "bottom" }, isActive
                                            ? (jsx(Button, { icon: true, disabled: false },
                                                jsx(Icon, { icon: activeIcon, size: "16", color: isActive
                                                        ? theme.colors.primary
                                                        : theme.colors.light })))
                                            : (jsx(Button, { icon: true, onClick: () => {
                                                    this.switchVersion(v);
                                                } },
                                                jsx(Icon, { icon: notActiveIcon, size: "16", color: theme.colors.palette.primary[200] }))))))
                                    : (''),
                                v.hasOwnProperty('isLocked') &&
                                    v.isLocked === false &&
                                    validToken &&
                                    canEdit &&
                                    v.versionName.toLowerCase() !== 'sde.default' && (jsx("div", { style: {
                                        display: 'flex',
                                        flex: 1,
                                        flexDirection: 'row',
                                        paddingLeft: 5
            ...
            */
            ...
            if (this.state.filteredVersionList.length > 0) {
                this.state.filteredVersionList[this.state.currentDisplayIndex].forEach((v) => {
                    if (this.state.selectedVersion.hasOwnProperty('versionGuid')) {
            ...
            const generateRows = (v) => {
                ...
                localFields.forEach((fld, i) => {
                    if (fld.show) {
                        if (fld.field === 'versionName') {
                            if (isSelected) {
                                fieldsList.push(jsx("td", { key: v.versionGuid, style: {
                                        width: '100%',
                                ...
                                fieldsList.push(jsx("td", { key: v.versionGuid, style: { width: '100%', wordBreak: 'break-all' } }, v.versionName));
                            }
                        }
                    }
                });
                versionList.push(jsx("tr", { key: v.versionName },
                    jsx("td", { style: { paddingTop: 3, paddingBottom: 3 } },
                        jsx(Tooltip, { title: isSelected
                                ? this.formatMessage('tooltipsCurrentVersion')
                                : this.formatMessage('tooltipsSwitchVersion'), placement: "bottom" },
                            jsx(Button, { icon: true, onClick: () => {
                                    this.switchVersion(v);
                                } },
                                jsx(Icon, { icon: isSelected ? activeIcon : notActiveIcon, size: "16", color: isSelected
                                        ? theme.colors.primary
                                        : theme.colors.palette.primary[200] })))),
                    jsx("td", { width: "1%" }),
                    jsx("td", null, v.hasOwnProperty('isLocked')
                        ? (v.isLocked
                            ? (jsx(Icon, { icon: lockIcon, size: "15", color: theme.colors.dark }))
                            : (jsx("div", { style: { width: 15, height: 15 } })))
                        : (jsx("div", { style: { width: 15, height: 15 } }))),
        ...
        this.renderVersionModification = () => {
            ...
            if (configObj !== null && this.state.selectedService !== '') {
                const allowanceList = configObj.configuredSettings.allowance;
                const deleteFilter = allowanceList.filter((al) => {
            ...
            return (jsx("div", { style: {
                ...
                jsx(Alert, { form: "basic", type: "warning", className: "w-100 m-2", open: this.state.showCreationAlert, text: this.state.creationAlertMsg }),
                jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                    jsx("div", { style: { flex: 1, fontWeight: 'bold', fontSize: 'large' } }, this.state.versionAction !== 'create'
                        ? this.formatMessage('otherheadersManageVersion')
                        : this.formatMessage('otherheadersNewVersion')),
                    jsx("div", { style: { flex: 3 } },
                        jsx(Tooltip, { title: this.formatMessage('tooltipsCharLimit62'), placement: "bottom" },
                            jsx(TextArea, { maxLength: 62, className: "mb-3", placeholder: this.formatMessage('placeholderVersionNameText'), 
                                //checkValidityOnChange={(value) => ({ valid: value !== "" })}
                                disabled: this.state.versionAction === 'create'
                                    ? false
                                    : !canUpdateName, defaultValue: this.state.versionObject.versionName, onAcceptValue: (name) => {
                                    if (name !== '') {
                ...
                jsx("div", { style: { display: 'flex', flexDirection: 'column' } },
                    jsx("h6", { style: { fontWeight: 'bold', fontSize: 'large' } }, this.formatMessage('versionmanagementDescription')),
                    jsx(Tooltip, { title: this.formatMessage('tooltipsCharLimit64'), placement: "bottom" },
                        jsx(TextArea, { maxLength: 64, className: "mb-3", placeholder: this.formatMessage('placeholderVersionDescriptionText'), disabled: this.state.versionAction === 'create'
                                ? false
                                : !canUpdateDetails, value: this.state.versionObject.versionDescription, onChange: (e) => {
                                this.manageNewVersionData(e.target.value, 'versionDescription');
                            } }))),
                jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                    jsx("div", { style: { display: 'flex', flexDirection: 'column', flex: 1.5 } },
                        jsx("h6", { style: { fontWeight: 'bold', fontSize: 'large' } }, this.formatMessage('versionmanagementAccessPrivileges')),
                        jsx(FormGroup, { tag: "fieldset", row: true, style: { fontSize: 'medium' } },
                            jsx(Col, { sm: 10 },
                                jsx(FormGroup, { check: true },
                                    jsx(Label, { check: true },
                                        jsx(Input, { type: "radio", name: "sharePublic", value: "public", disabled: !canUpdateAccess, checked: this.state.versionObject.versionScope === 'public', onChange: (e) => {
                                                this.manageNewVersionData(e.target.value, 'versionScope');
                                            } }),
                                        ' ',
                                        this.formatMessage('versionmanagementPublicAccess'))),
                                jsx(FormGroup, { check: true },
                                    jsx(Label, { check: true },
                                        jsx(Input, { type: "radio", name: "sharePublic", value: "protected", disabled: !canUpdateAccess, checked: this.state.versionObject.versionScope === 'protected', onChange: (e) => {
                                                this.manageNewVersionData(e.target.value, 'versionScope');
                                            } }),
                                        ' ',
                                ...
                                jsx(FormGroup, { check: true },
                                    jsx(Label, { check: true },
                                        jsx(Input, { type: "radio", name: "sharePrivate", value: "private", disabled: !canUpdateAccess, checked: this.state.versionObject.versionScope === 'private', onChange: (e) => {
                                                this.manageNewVersionData(e.target.value, 'versionScope');
                                            } }),
                                        ' ',
                                        this.formatMessage('versionmanagementPrivateAccess'))))),
                        jsx("div", { style: { display: 'flex', flexDirection: 'row', paddingTop: 10 } },
                            jsx("div", { style: { display: 'flex', flex: 1, flexDirection: 'column' } },
                                jsx("h6", { style: { fontWeight: 'bold', fontSize: 'large' } }, this.formatMessage('versionmanagementActivateVersion')),
                                jsx("div", { style: { display: 'flex', flex: 1, flexDirection: 'row' } },
                                    jsx("div", { style: { fontSize: 'medium' } }, this.formatMessage('versionmanagementNo')),
                                    jsx("div", { style: { paddingLeft: 5, paddingRight: 5, paddingTop: 5 } },
                                        jsx(Label, { check: true },
                                            jsx(Switch, { checked: this.state.autoSwitchVersion, disabled: !canSwitch, onChange: (evt) => {
                                                    this.toggleAutoSwitch();
                                                } }))),
                                    jsx("div", { style: { fontSize: 'medium' } }, this.formatMessage('versionmanagementYes')))))),
                    jsx("div", { style: { display: 'flex', flexDirection: 'column', flex: 1 } },
                        jsx(FormGroup, null,
                            jsx("h6", { style: { fontWeight: 'bold', fontSize: 'large' } }, this.formatMessage('versionmanagementChangeOwner')),
                            jsx("h6", { style: { fontWeight: 'bold', fontSize: 'medium' } },
                            ...
                            jsx(InputGroup, null,
                                jsx(TextInput, { type: "text", style: { width: '100%' }, placeholder: this.formatMessage('placeholderSearchOwner'), disabled: !canUpdateOwner, value: this.state.userSearchValue, onChange: (e) => {
                ...
                jsx("div", { style: {
                    ...
                    jsx("div", { style: {
                        ...
                        jsx(Button, { type: "secondary", style: { fontSize: 'medium', fontWeight: 'bold' }, onClick: (evt) => {
                    ...
                    jsx("div", { style: {
                        ...
                        jsx("div", { style: {
                            ...
                            jsx(Button, { type: "primary", style: { fontSize: 'medium', fontWeight: 'bold' }, disabled: this.state.invalidVersionName
                                    ? this.state.invalidVersionName
                                    : this.state.disableSave, onClick: () => {
                            ...
                            this.state.versionAction !== 'create'
                                ? (canDelete
                                    ? (jsx("div", { style: { width: '2%' } }))
                                    : (''))
                                : (''),
                            this.state.versionAction !== 'create'
                                ? (canDelete
                                    ? (jsx(Button, { type: "secondary", style: { fontSize: 'medium', fontWeight: 'bold' }, disabled: this.state.invalidVersionName, onClick: () => {
        ...
        this.renderFieldList = () => {
            ...
            const onlyOneShown = () => {
                let result = false;
                const shown = localFields.filter((lf) => {
                    return lf.show === true;
                });
                if (shown.length <= 1) {
                    result = true;
            ...
            localFields.forEach((fld, i) => {
                if (fld.available || fld.show) {
                    fieldsList.push(jsx("tr", { key: fld.field },
                        jsx("td", { style: { fontSize: 'medium', paddingLeft: 5, paddingRight: 5 } }, fld.alias),
                        fld.available ? (jsx("td", null,
                            jsx(Tooltip, { title: fld.show
                                    ? this.formatMessage('tooltipsRemoveFromTable')
                                    : this.formatMessage('tooltipsAddToTable'), placement: "bottom" },
                                jsx(Checkbox, { className: "m-3", checked: fld.show, disabled: fld.show ? disableChk : false, onChange: (evt) => {
                                        //evt.preventDefault();
                                        this.changeFieldVisible(evt, i);
                                    } })))) : (jsx("td", null,
                            jsx(Tooltip, { title: this.formatMessage('tooltipsNotAvailableField'), placement: "bottom" },
                                jsx(Checkbox, { className: "m-3", checked: fld.show, disabled: true })))),
                        jsx("td", { style: { paddingLeft: 5, paddingRight: 5 } },
                            jsx("div", { style: { display: 'flex', flexDirection: 'row' } },
                                i > 0
                                    ? (jsx(Tooltip, { title: this.formatMessage('tooltipsMoveColumnUp'), placement: "bottom" },
                                        jsx(Button, { icon: true, type: "tertiary", size: "sm", onClick: () => {
                                                this.changeFieldOrder('up', i);
                                            } },
                                            jsx(Icon, { icon: upArrowIcon, size: "16", color: "#333" }))))
                                    : (jsx(Button, { icon: true, type: "tertiary", size: "sm" })),
                                i < localFields.length - 1
                                    ? (jsx(Tooltip, { title: this.formatMessage('tooltipsMoveColumnDown'), placement: "bottom" },
                                        jsx(Button, { icon: true, type: "tertiary", size: "sm", onClick: () => {
                                                this.changeFieldOrder('down', i);
                                            } },
                                            jsx(Icon, { icon: downArrowIcon, size: "16", color: "#333" }))))
                                    : (jsx(Button, { icon: true, type: "tertiary", size: "sm" }))))));
                }
            });
            return (jsx("table", { style: {} },
                jsx("thead", null,
                    jsx("tr", null,
                        jsx("th", { style: {
                                fontSize: 'medium',
                ...
                jsx("tbody", null, fieldsList)));
        };
        //END of render components
        //***********************
        //********************************* */
        //START FUNCTIONS ON VERSION MANAGEMENT
        this.pullVersions = (service, serviceSwitch) => {
                            ...
                            if (result.success) {
                                if (result.hasOwnProperty('versions')) {
                                    ...
                                    if (this.state.selectedVersion !== '') {
                                        if (this.state.selectedVersion.hasOwnProperty('versionGuid')) {
                                            if (this.state.selectedVersion.versionGuid !== '') {
                                                const pos = vList.findIndex((x) => x.versionGuid ===
                                                ...
                                                if (pos > -1) {
                                                    ...
                                                    const findDefault = this.state.versionList.filter((v) => {
                                                        return (v.versionName.toLowerCase() ===
                                    ...
                                    this.setState(updateObject, () => {
                                        ...
                                        this.setState({
                                            ...
                                            if (serviceSwitch) {
                                                ...
                                                const persist = this.state.versionList.filter((v) => {
                                                ...
                                                if (persist.length > 0) {
                                                    ...
                                                    const found = this.state.versionList.filter((v) => {
                                                        return (v.versionGuid === configObj.configuredSettings.startupVersion);
                                                    });
                                                    if (found.length > 0) {
                                                        ...
                                                        const findDefault = this.state.versionList.filter((v) => {
                                                            return (v.versionName.toLowerCase() === this.defaultVersion.toLowerCase());
                                                        });
                                                        if (findDefault.length > 0) {
                                                            this.switchVersion(findDefault[0]);
                                                        }
        ...
        this._checkStatus = () => {
            this._getVersionStatus().then((res) => {
                this._mergeStatus(res);
            });
        };
        this._getVersionStatus = () => {
            return new Promise((resolve, reject) => {
                if (this.state.filteredVersionList.length > 0) {
                    const configObj = this._getConfigServiceObject();
                    if (configObj !== null) {
                        ...
                        const status = [];
                        const promises = this.state.filteredVersionList[this.state.currentDisplayIndex].map((filtered) => __awaiter(this, void 0, void 0, function* () {
                            yield this.vms
                                .getVersionState(filtered, validToken, this.state.selectedService, configObj.url)
                                .then((result) => {
                        ...
                        if (this.state.selectedVersion.hasOwnProperty('versionGuid') &&
                            ...
                            promises.push(this.vms
                                .getVersionState(this.state.selectedVersion, validToken, this.state.selectedService, configObj.url)
                                .then((result) => {
                                if (result.hasOwnProperty('versionName')) {
                                    status.push(result);
                                }
        ...
        this._mergeStatus = (result) => {
            if (this.state.filteredVersionList.length > 0) {
                const localList = [...this.state.filteredVersionList];
                localList[this.state.currentDisplayIndex].forEach((filtered) => {
                    const found = result.filter((r) => {
                ...
                if (this.state.selectedVersion.hasOwnProperty('versionGuid') &&
                    this.state.selectedVersion.versionGuid !== null) {
                    const localActive = Object.assign({}, this.state.selectedVersion);
                    const foundActive = result.filter((r) => {
        ...
        this.switchVersion = (evt) => __awaiter(this, void 0, void 0, function* () {
            const list = [];
            const currService = this.state.vmsServices.filter((vms) => {
            ...
            if (currService.length > 0) {
                ...
                for (const key in this.state.dsList) {
                    if (this.state.dsList[key].hasOwnProperty('_url') &&
            ...
            if (currService.length > 0) {
                ...
                this.setState({
                    ...
                    this.pullVersions(this.state.selectedService, false).then((res) => {
                        if (this.state.searchVersionValue !== '') {
                            this.searchVersions(this.state.searchVersionValue);
                        }
                        if (this.state.sort.field !== '') {
            ...
            if (configObj !== null) {
                if (this.state.versionObject.versionName !== '') {
                    ...
                    this.setState({
                        ...
                        this.vms
                            .createGDBVersion(this.state.versionObject, validToken, this.state.dsList, this.state.selectedService, configObj.url, this.state.autoSwitchVersion)
                            .then((result) => __awaiter(this, void 0, void 0, function* () {
                            if (result.success) {
                                //if user created with a different user, need to send an update after creation since it doesn't let you on create.
                                if (this.state.versionObject.versionOwner.toLowerCase() !==
                                    defaultUser.toLowerCase()) {
                                    if (this.state.versionObject.versionOwner === '') {
                                        //if it's blank, process normally
                                        yield this.pullVersions(this.state.selectedService, false);
                                        if (this.state.autoSwitchVersion) {
                                            const configItem = Immutable.asMutable(Immutable(this.state.configObj), { deep: true });
                                            configItem.services.forEach((s) => {
                                                if (this.state.selectedService === s.name) {
                                        ...
                                        const local = Object.assign({}, this.state.versionObject);
                                        local.versionGuid = result.versionInfo.versionGuid;
                                        if (this.state.autoSwitchVersion) {
                                            this.setState({ versionObject: local }, () => __awaiter(this, void 0, void 0, function* () {
                                                //this.pullVersions(this.state.selectedService, false).then(()=>{
                                                this.updateVersion();
                                                //});
                                            }));
        ...
        this.deleteVersion = () => {
            ...
            if (configObj !== null) {
                ...
                this.vms
                    .deleteGDBVersion(this.state.versionObject.version, validToken, this.state.dsList, this.state.selectedService, configObj.url)
                    .then((result) => __awaiter(this, void 0, void 0, function* () {
                    if (result.success) {
                        yield this.pullVersions(this.state.selectedService, false);
                        if (this.state.versionObject.versionGuid ===
                            this.state.selectedVersion.versionGuid) {
                            const defaultInfo = this.state.versionList.filter((v) => {
                                return (v.versionName.toLowerCase() ===
                                    this.defaultVersion.toLowerCase());
                            });
                            if (defaultInfo.length > 0) {
                                ...
                                this.setState({
                                    ...
                                    deleteAlertMsg: '',
                                    selectedVersion: defaultInfo.length > 0
                                        ? defaultInfo[0]
                                        : this.defaultVersion,
                                    selectedVersionInfo: defaultInfo.length > 0 ? defaultInfo[0] : '',
                                    showVersionSettingsModal: false,
                                    configObj: configItem
                                }, () => {
                                    if (this.state.searchVersionValue !== '') {
            ...
            if (configObj !== null) {
                if (this.state.versionObject.versionName !== '') {
                    ...
                    this.setState({
                        ...
                        this.vms
                            .alterGDBVersion(this.state.versionObject, validToken, this.state.dsList, this.state.selectedService, configObj.url, this.state.autoSwitchVersion)
                            .then((result) => __awaiter(this, void 0, void 0, function* () {
                            if (result.success) {
                                yield this.pullVersions(this.state.selectedService, false);
                                const versionFound = this.state.versionList.filter((v) => {
                                    return (v.versionGuid === this.state.versionObject.versionGuid);
                                });
                                if (versionFound.length > 0) {
                                    if (this.state.autoSwitchVersion) {
                                        ...
                                        if (versionFound[0].versionName.toLowerCase() ===
        ...
        this.searchVersions = (value) => {
            ...
            if (this.state.sort.field !== '') {
                filtered.sort(this._compare(this.state.sort.field, this.state.sort.direction));
            }
        ...
        this.loadExistingVersion = (evt) => {
            if (evt.versionName.toLowerCase() !== this.defaultVersion.toLowerCase()) {
                const currVer = this.state.versionList.filter((v) => {
                    return v.versionGuid === evt.versionGuid;
                });
                if (currVer.length > 0) {
                    let isActive = false;
                    const verObj = Object.assign({}, this.state.versionObject);
                    if (currVer[0].versionGuid === this.state.selectedVersion.versionGuid) {
                        isActive = true;
                    }
                    verObj.version = currVer[0].versionName;
                    verObj.versionName = currVer[0].versionName.substring(currVer[0].versionName.lastIndexOf('.') + 1, currVer[0].versionName.length);
                    verObj.versionDescription = currVer[0].description;
                    verObj.versionScope = currVer[0].access;
                    verObj.versionOwner = currVer[0].versionName.substring(0, currVer[0].versionName.lastIndexOf('.'));
                    ...
                    if (evt.versionGuid === this.state.selectedVersion.versionGuid) {
                        ...
                        verObj.versionName = this.state.selectedVersion.versionName.substring(this.state.selectedVersion.versionName.lastIndexOf('.') + 1, this.state.selectedVersion.versionName.length);
                        verObj.versionDescription = this.state.selectedVersion.description;
                        verObj.versionScope = this.state.selectedVersion.access;
                        verObj.versionOwner =
                            this.state.selectedVersion.versionName.substring(0, this.state.selectedVersion.versionName.lastIndexOf('.'));
        ...
        this.manageNewVersionData = (value, field) => {
            const newVersion = Object.assign({}, this.state.versionObject);
        ...
        this.searchPortaluser = (value) => {
            ...
            this.vms
                ...
                if (result.hasOwnProperty('results')) {
                    ...
                    this.setState({ userSearchValue: searchVal, portalUsers: filtered }, () => { });
                }
                else {
        ...
        this.searchUserResultList = () => {
            ...
            if (this.state.portalUsers.length > 0) {
                this.state.portalUsers.forEach((pu) => {
                    users.push(jsx(Button, { key: pu.username, type: this.state.versionObject.versionOwner === pu.username
                            ? 'primary'
                            : 'secondary', onClick: () => {
                ...
                if (this.state.userSearchValue !== '') {
                    users.push(jsx(Button, { key: 'no_user', type: 'secondary' }, this.formatMessage('versionmanagementNoUserFound')));
                }
            }
            return jsx(ListGroup, null, users);
        };
        //END managing versions in UI
        //************************* */
        //********************** */
        //UI Helper functions
        this.chunkVersions = (array) => {
        ...
        this._filterRuntimeFields = () => {
            const configObj = this._getConfigServiceObject();
            if (configObj !== null) {
                const fields = Immutable.asMutable(Immutable(configObj.configuredSettings.displayInfo), { deep: true });
        ...
        this._getRefreshInterval = () => {
            ...
            if (configObj !== null) {
                ...
                const refreshNode = allowance.filter((a) => {
        ...
        this.sortVersions = (parameter, direction) => {
        ...
        this.changeFieldVisible = (evt, index) => {
            const localFields = [...this.state.fieldColumns];
            localFields.sort(this._compare('order', 'desc'));
        ...
        this.toggleCreationModel = (status) => {
            if (status) {
                this.setState({
                    showVersionSettingsModal: false,
                    showCreationAlert: false,
        ...
        this.toggleServiceSelectorModal = (status) => {
            if (status) {
        ...
        this.toggleBackServiceSelector = () => {
            this.setState({ showServiceSelector: true });
        };
        ...
        this._getConfigServiceObject = () => {
            let configObj = null;
            const versionConfig = this.state.configObj;
            if (versionConfig !== null) {
                versionConfig.services.forEach((s) => {
                    if (this.state.selectedService !== '') {
                        if (this.state.selectedService === s.name) {
                            configObj = s;
                        }
        ...
        this.checkPortalIfFederated = (baseURL) => {
    ...
    `;
        ...
        this.state = {
            isReady: false,
            isSimpleMode: this.props.config.versionConfig.hasOwnProperty('arrangement')
            ...
            versionList: [],
            filteredVersionList: [],
            configObj: Immutable.asMutable(Immutable(this.props.config.versionConfig), { deep: true }),
            selectedService: '',
    ...
    componentDidMount() {
        ...
        if (((_a = config.versionConfig) === null || _a === void 0 ? void 0 : _a.services.length) > 0) {
            const queryObject = getAppStore().getState().queryObject;
            if (queryObject) {
                if (queryObject === null || queryObject === void 0 ? void 0 : queryObject.data_version) {
    ...
    componentDidUpdate(preProps, preState) {
        ...
        if (window.jimuConfig.isInBuilder) {
            ...
            if (config.versionConfig.hasOwnProperty('arrangement')) {
                if (preProps.config.versionConfig.arrangement !==
            ...
            if (config.versionConfig.hasOwnProperty('expandMode')) {
                if (preProps.config.versionConfig.expandMode !==
            ...
            if (config.versionConfig.hasOwnProperty('services')) {
                if (preProps.config.versionConfig.services.length !==
                    ...
                    if (config.versionConfig.services.length > 0) {
                        this.setState({ configObj: config.versionConfig }, () => {
                            this.setState({
                                ...
                                this._filterRuntimeFields();
                                this.pullVersions(this.state.selectedService, false).then(() => {
                                    const foundVersion = this.state.versionList.filter((vl) => {
                                        ...
                                        return (vl.versionName === startupVersion || vl.versionGuid === startupVersion);
                                    });
            ...
            if (config.versionConfig.hasOwnProperty('pageCounter')) {
                if (preProps.config.versionConfig.pageCounter !==
                    config.versionConfig.pageCounter) {
                    this.setState({ maxDisplayRows: parseInt(config.versionConfig.pageCounter) }, () => {
            ...
            if (config.versionConfig.hasOwnProperty('services')) {
                if (config.versionConfig.services.length > 0) {
                    if (this.state.selectedService !== '') {
                        const preService = preProps.config.versionConfig.services.filter((pS) => {
                            return pS.activeInBuilder === true;
                        });
                        const curService = config.versionConfig.services.filter((s) => {
                            return s.activeInBuilder === true;
                        });
                        if (!lodash.isDeepEqual(preProps.config.versionConfig.services[0].name, config.versionConfig.services[0].name)) {
                            this.forceUpdate();
                        }
                        if (preService.length > 0 && curService.length > 0) {
                            if (!lodash.isDeepEqual(preService[0].configuredSettings.displayInfo, curService[0].configuredSettings.displayInfo)) {
                                this.setState({ configObj: config.versionConfig }, () => {
                                    this._filterRuntimeFields();
                                });
                            }
                            if (!lodash.isDeepEqual(preService[0].configuredSettings.allowance, curService[0].configuredSettings.allowance)) {
                                this.setState({ configObj: config.versionConfig });
                            }
                            if (!lodash.isDeepEqual(preService[0].configuredSettings.startupVersion, curService[0].configuredSettings.startupVersion)) {
                                this.pullVersions(this.state.selectedService, false).then(() => {
                                    const foundVersion = this.state.versionList.filter((vl) => {
    ...
    render() {
        ...
        if (this.props.config.versionConfig.services.length <= 0) {
            return (jsx(WidgetPlaceholder, { icon: pathIconImage, widgetId: this.props.id, message: this.formatMessage('_widgetLabel') }));
        }
        let isOpen = true;
        const widState = getAppStore().getState().widgetsRuntimeInfo;
        if (widState.hasOwnProperty(this.props.widgetId)) {
        ...
        return (jsx("div", { className: "gdb-version-management jimu-widget display-flex-column-1 overflow-auto", style: {
                backgroundColor: theme.surfaces[1].bg,
                height: '100%',
                padding: 10
            }, css: this.getStyle(this.props.theme) },
            this.state.isReady === false && jsx(DataSourceComponent, { useDataSource: this.props.useDataSources && this.props.useDataSources[0], onDataSourceCreated: () => {
                    this._populateSwitchableSources('runtime');
                }, widgetId: this.props.id }),
            this.state.isReady && !this.state.showVersionSettingsModal && jsx("div", { id: this.widRefForPopper }, this.renderServiceSelector()),
            this.state.showVersionSettingsModal &&
                this.renderVersionModification(),
            jsx(Modal, { isOpen: this.state.showDeleteModal },
                jsx(ModalHeader, { toggle: (evt) => {
                        this.toggleDeleteModal(true);
                    } }, this.formatMessage('modalheaderDeleteVersion')),
                jsx(ModalBody, null,
                    jsx(Alert, { form: "basic", type: "warning", className: "w-100", open: this.state.showDeleteAlert, text: this.state.deleteAlertMsg }),
                ...
                this.state.versionObject.hasOwnProperty('version')
                    ? (this.state.versionObject.version.toLowerCase() !==
                        ...
                        ? (jsx(ModalFooter, null,
                            jsx(Button, { type: "primary", onClick: this.deleteVersion }, this.formatMessage('versionmanagementYes')),
                            ' ',
                            jsx(Button, { type: "secondary", onClick: (evt) => {
                                    this.toggleDeleteModal(true);
                                } }, this.formatMessage('versionmanagementNo'))))
                        : (''))
                    : ('')),
            jsx(Modal, { isOpen: this.state.showUpdateModal },
                jsx(ModalHeader, { toggle: (evt) => {
                        this.toggleUpdateModal(true);
                    } }, this.formatMessage('modalheaderUpdateVersion')),
                jsx(ModalBody, null,
                    jsx(Alert, { type: "warning", form: "basic", className: "w-100", text: this.formatMessage('actionLabelsCannotDelete') }))),
            jsx(Popper, { open: isOpen ? this.state.showFieldMgmt : false, floating: false, reference: this.props.widgetId + '_btnFieldMgmt', placement: 'left-start', showArrow: true, onHeaderClose: () => {
                    this.toggleDialogAction('fieldMgmt', 'showFieldMgmt');
                }, zIndex: 2001 },
                jsx("div", { style: {
                        width: '100%',
                        height: this.state.fieldColumns.length < 5
                            ? 'auto'
