...
describe('Profile chart test cases', () => {
    ...
    const wrapper = shallow(React.createElement(Chart, Object.assign({}, props)));
    ...
    it('Validate the distance and elevation values for ground elevation and profile line are converted', function () {
        ...
        const value = currentInstance.getDistanceAsPerConfiguredFieldAndUnits(configuredSettings, selectedGraphic);
        expect(value).toEqual(10000);
    });
    it('Validate that the chart object is made when a segment is drawn or selected', function () {
...
//# sourceMappingURL=profile-chart.test.js.map