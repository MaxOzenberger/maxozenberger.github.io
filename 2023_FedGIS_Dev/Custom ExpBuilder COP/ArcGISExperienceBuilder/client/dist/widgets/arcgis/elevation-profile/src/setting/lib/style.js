...
export function getProfileChartStyle(theme) {
    return css `
    .selectOption {
      width: 114px;
    }
...
export function getPopupStyle(theme) {
...
export function getStyleForLI(theme) {
    return css `
    .layer-item-panel {
      .setting-header {
...
export function getAdvanceSettingsStyle(theme) {
    return css `
    .hidden {
      display: none;
    }
...
export function getSidePanelStyle(theme) {
    return css `
    position: absolute;
    top: 0;
    bottom: 0;
...
export function getGeneralSettingsStyle(theme) {
    return css `
    .hidden {
      display: none;
    }
...
export function getStatisticsListStyle(theme) {
    return css `
    .color-label {
      color: ${theme.colors.palette.dark[400]};
    }
