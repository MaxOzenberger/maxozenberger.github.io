...
export default class Chart extends React.PureComponent {
    constructor(props) {
        ...
        this.componentDidUpdate = (prevProps) => {
            ...
            if ((((_a = prevProps.commonGeneralSettings) === null || _a === void 0 ? void 0 : _a.showGridAxis) !== ((_b = this.props.commonGeneralSettings) === null || _b === void 0 ? void 0 : _b.showGridAxis) &&
                ((_c = this.chart) === null || _c === void 0 ? void 0 : _c.xAxes.values.length) > 0 && this.chart.yAxes.values.length > 0) ||
                prevProps.elevationGraphColor !== this.props.elevationGraphColor) {
                if (this.chart) {
                    this.xAxis.renderer.grid.template.disabled = !((_d = this.props.commonGeneralSettings) === null || _d === void 0 ? void 0 : _d.showGridAxis);
                    this.yAxis.renderer.grid.template.disabled = !((_e = this.props.commonGeneralSettings) === null || _e === void 0 ? void 0 : _e.showGridAxis);
            ...
            if (((_f = prevProps.commonGeneralSettings) === null || _f === void 0 ? void 0 : _f.showLegend) !== ((_g = this.props.commonGeneralSettings) === null || _g === void 0 ? void 0 : _g.showLegend) ||
                ((_h = prevProps.commonGeneralSettings) === null || _h === void 0 ? void 0 : _h.showAxisTitles) !== ((_j = this.props.commonGeneralSettings) === null || _j === void 0 ? void 0 : _j.showAxisTitles)) {
                this.xAxis.title.visible = (_k = this.props.commonGeneralSettings) === null || _k === void 0 ? void 0 : _k.showAxisTitles;
                this.xAxis.title.textAlign = 'middle';
                this.yAxis.title.visible = (_l = this.props.commonGeneralSettings) === null || _l === void 0 ? void 0 : _l.showAxisTitles;
                this.yAxis.title.textAlign = 'middle';
                if (this.isRTL) {
                    this.chart.padding(0, ((_m = this.props.commonGeneralSettings) === null || _m === void 0 ? void 0 : _m.showAxisTitles) ? 5 : -10, (((_o = this.props.commonGeneralSettings) === null || _o === void 0 ? void 0 : _o.showAxisTitles) && ((_p = this.props.commonGeneralSettings) === null || _p === void 0 ? void 0 : _p.showLegend))
                        ? 4
                        : (((_q = this.props.commonGeneralSettings) === null || _q === void 0 ? void 0 : _q.showAxisTitles) && !((_r = this.props.commonGeneralSettings) === null || _r === void 0 ? void 0 : _r.showLegend))
                            ? -2
                            : (!((_s = this.props.commonGeneralSettings) === null || _s === void 0 ? void 0 : _s.showAxisTitles) && ((_t = this.props.commonGeneralSettings) === null || _t === void 0 ? void 0 : _t.showLegend))
                                ? 0
                                : (!((_u = this.props.commonGeneralSettings) === null || _u === void 0 ? void 0 : _u.showAxisTitles) && !((_v = this.props.commonGeneralSettings) === null || _v === void 0 ? void 0 : _v.showLegend))
                                    ? -25
                                    : 0, 5);
                }
                else {
                    this.chart.padding(0, 5, (((_w = this.props.commonGeneralSettings) === null || _w === void 0 ? void 0 : _w.showAxisTitles) && ((_x = this.props.commonGeneralSettings) === null || _x === void 0 ? void 0 : _x.showLegend))
                        ? 4
                        : (((_y = this.props.commonGeneralSettings) === null || _y === void 0 ? void 0 : _y.showAxisTitles) && !((_z = this.props.commonGeneralSettings) === null || _z === void 0 ? void 0 : _z.showLegend))
                            ? -2
                            : (!((_0 = this.props.commonGeneralSettings) === null || _0 === void 0 ? void 0 : _0.showAxisTitles) && ((_1 = this.props.commonGeneralSettings) === null || _1 === void 0 ? void 0 : _1.showLegend))
                                ? 0
                                : (!((_2 = this.props.commonGeneralSettings) === null || _2 === void 0 ? void 0 : _2.showAxisTitles) && !((_3 = this.props.commonGeneralSettings) === null || _3 === void 0 ? void 0 : _3.showLegend))
                                    ? -25
                                    : 0, ((_4 = this.props.commonGeneralSettings) === null || _4 === void 0 ? void 0 : _4.showAxisTitles) ? 5 : -10);
                }
                ...
                this.setState({
                    showLegend: (_5 = this.props.commonGeneralSettings) === null || _5 === void 0 ? void 0 : _5.showLegend
                }, () => {
                    var _a;
                    if (this.state.showLegend) {
                        ...
                        if ((_a = this.chart) === null || _a === void 0 ? void 0 : _a.legend) {
                            this.chart.legend.visible = this.state.showLegend;
                        }
                    }
                });
            ...
            const profileSettingsChanged = this.didProfileLayersSettingsChanged((_6 = prevProps.currentConfig) === null || _6 === void 0 ? void 0 : _6.profileSettings.layers, (_7 = this.props.currentConfig) === null || _7 === void 0 ? void 0 : _7.profileSettings.layers);
            if (profileSettingsChanged ||
                ...
                ((_8 = prevProps.currentConfig) === null || _8 === void 0 ? void 0 : _8.advanceOptions) !== ((_9 = this.props.currentConfig) === null || _9 === void 0 ? void 0 : _9.advanceOptions)) {
                ...
                if ((profileSettingsChanged ||
                    ...
                    ((_10 = prevProps.currentConfig) === null || _10 === void 0 ? void 0 : _10.advanceOptions) !== ((_11 = this.props.currentConfig) === null || _11 === void 0 ? void 0 : _11.advanceOptions)) && this.chart) {
                    this.chart.dispose();
                    this.chart = null;
                }
                this.updatedProfileLayers = (_12 = this.props.currentConfig) === null || _12 === void 0 ? void 0 : _12.profileSettings.layers;
                this.createOrUpdateChartDefinition();
            }
        };
        this.didProfileLayersSettingsChanged = (prevSettings, newSettings) => {
            let isLayersSettingsChanged = false;
            if ((newSettings === null || newSettings === void 0 ? void 0 : newSettings.length) !== (prevSettings === null || prevSettings === void 0 ? void 0 : prevSettings.length)) {
                return true;
            }
            //eslint-disable-next-line
            newSettings === null || newSettings === void 0 ? void 0 : newSettings.some((newLayersSettings, index) => {
                        ...
                        this.createDataForProfileLines(allElevations).then((updatedData) => {
                            ...
                            this.setState({
                                ...
                                this.createChart({
                                    ...
                                    showGrid: (_a = this.props.commonGeneralSettings) === null || _a === void 0 ? void 0 : _a.showGridAxis,
                                    showTitleAxis: (_b = this.props.commonGeneralSettings) === null || _b === void 0 ? void 0 : _b.showAxisTitles,
        ...
        this.checkForProfileSettings = () => {
            var _a, _b, _c, _d;
            const uniqueSelectedProfileLines = [];
            if (((_b = (_a = this.props.drawingLayer) === null || _a === void 0 ? void 0 : _a.graphics) === null || _b === void 0 ? void 0 : _b.length) > 0 &&
                ((_d = (_c = this.props.drawingLayer.graphics.getItemAt(0)) === null || _c === void 0 ? void 0 : _c.attributes) === null || _d === void 0 ? void 0 : _d.esriCTFeatureLayerId)) {
        ...
        this._updateProfileResults = (profileResults) => {
            ...
            elevationProfileResults.elevations = convertElevationsInfoArray(profileResults.elevations, profileResults.effectiveUnits.distance, profileResults.effectiveUnits.elevation, this.props.selectedLinearUnit, this.props.selectedElevationUnit);
        ...
        this.getNearestElevationData = (chartObjectX) => {
        ...
        this.getNearestFlippedElevationData = (chartObjectX) => {
        ...
        */
        this.createChart = (params) => __awaiter(this, void 0, void 0, function* () {
            var _d;
            const amCharts4Index = yield chartUtils.loadChartsModule();
            if (!amCharts4Index) {
                return;
            }
            ...
            this.chart = chart;
            if (isRTL) {
                chart.padding(0, params.showTitleAxis ? 5 : -10, (params.showTitleAxis && params.showLegend)
                    ? 4
                ...
                chart.padding(0, 5, (params.showTitleAxis && params.showLegend)
                    ? 4
                    : (params.showTitleAxis && !params.showLegend)
                        ? -2
                        : (!params.showTitleAxis && params.showLegend)
                            ...
                            : (!params.showTitleAxis && !params.showLegend)
                                ? -25
                                : 0, params.showTitleAxis ? 5 : -10);
            }
            //Add data
            chart.data = params.definition.data;
            //Use the configured graph color as a ground color for area chart
            const groundColor = ((_d = params.definition.series[0]) === null || _d === void 0 ? void 0 : _d.color) ? params.definition.series[0].color : '#b54900';
        ...
        this.profilingWithAdvanceOptions = () => {
            var _a;
            if ((_a = this.props.currentConfig) === null || _a === void 0 ? void 0 : _a.advanceOptions) {
        ...
        this.getAdjustedBounds = ({ data, pixelWidth, pixelHeight }) => {
        ...
        this.getUniformBounds = ({ bounds, pixelWidth, pixelHeight, centered }) => {
        ...
        this.scaleRange = ([min, max], scale, centered) => {
        ...
        this.configureTooltipCursorPosition = (ctx) => {
            ...
            cursor.events.on('cursorpositionchanged', (ev) => {
                ...
                if (nearestElevationData) {
                    ...
                    (_b = (_a = this.chart) === null || _a === void 0 ? void 0 : _a.series) === null || _b === void 0 ? void 0 : _b.values.forEach((series) => {
        ...
        this.createDataForProfileLines = (chartData) => __awaiter(this, void 0, void 0, function* () {
            var _e;
            const allPromises = [];
            if ((_e = this.props.currentConfig) === null || _e === void 0 ? void 0 : _e.advanceOptions) {
                const uniqueProfileLayers = this.checkForProfileSettings();
                if (uniqueProfileLayers.length > 0) {
                    const promise = new Promise((resolve, reject) => {
                        this.getDistanceOfAllSelectedFeatures().then((featuresDistances) => {
                            uniqueProfileLayers.forEach((layerId) => {
                                ...
                                this.props.drawingLayer.graphics.forEach((selectedFeature, index) => __awaiter(this, void 0, void 0, function* () {
                                    ...
                                    if ((config === null || config === void 0 ? void 0 : config.elevationSettings) && selectedLayerId === layerId) {
                                        ...
                                        yield allPromises.push(this.addElevationForSelectedFeature(config.elevationSettings, selectedFeature, currentFeatureLength, nextDataToBeUpdated, oldDistance));
                                    }
                                    else {
        ...
        this.getDistanceAsPerMapProjection = (geometry, unit) => {
        ...
        this.getConfiguredSettingsForLine = (selectedLayerId) => {
            return this.updatedProfileLayers.find((layer) => {
                return layer.layerId === selectedLayerId;
            });
        };
        this.getDistanceAsPerConfiguredFieldAndUnits = (configuredDistanceSettings, selectedFeature) => {
        ...
        this.updateMinMaxForProfile = (pointIndex, layerId, newValue) => {
        ...
        this.addElevationForSelectedFeature = (config, selectedFeature, currentFeatureLength, nextDataToBeUpdated, currentTotalDistance) => __awaiter(this, void 0, void 0, function* () {
            const promise = new Promise((resolve) => {
                ...
                if (config.type === 'one' && config.field1 && selectedFeature.attributes[config.field1] !== null) {
                    ...
                    if (((_a = currentGeometry.paths) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                        const segments = [];
                        let segmentIndex = 0;
                        ...
                        Promise.all(getDistancePromiseArray).then((segmentLengths) => {
                            ...
                            let totalSegLength = (_a = nextDataToBeUpdated[0]) === null || _a === void 0 ? void 0 : _a.x;
                            ...
                            segmentLengths.forEach((segmentLength, segmentIndex) => {
                                ...
                                if (this.props.mapView.view.type === '3d' && elevationInfo && (nextDataToBeUpdatedForSeg === null || nextDataToBeUpdatedForSeg === void 0 ? void 0 : nextDataToBeUpdatedForSeg.length) > 0) {
                                ...
                                nextDataToBeUpdatedForSeg.forEach((element) => {
                                    if (!element[layerId + 'y']) {
                                        ...
                                        if (this.props.mapView.view.type === '3d' && (elevationInfo === null || elevationInfo === void 0 ? void 0 : elevationInfo.mode) === 'on-the-ground') {
        ...
        this.getDistanceOfAllSelectedFeatures = () => {
            const getDistancePromiseArray = [];
        ...
        this.addLineSeries = (layerId, ctx) => {
            ...
            const dataSource = getAllLayersFromDataSource(this.props.activeDs);
            ...
            if ((configuredProfileSetting === null || configuredProfileSetting === void 0 ? void 0 : configuredProfileSetting.length) === 1) {
        ...
        this.makeFormatter = (axes, abbreviation) => {
            const formatter = axes.numberFormatter.clone();
            formatter.format = (value, _format, precision = 2) => {
        ...
        this.updatedProfileLayers = (_b = this.props.currentConfig) === null || _b === void 0 ? void 0 : _b.profileSettings.layers;
        this.state = {
            chartDefinition: null,
            showLegend: (_c = this.props.commonGeneralSettings) === null || _c === void 0 ? void 0 : _c.showLegend
        };
    }
    render() {
        return (jsx(React.Fragment, null, this.state && this.state.chartDefinition &&
            jsx("div", { tabIndex: -1, className: 'w-100 h-100 p-2' },
                jsx("div", { tabIndex: 0, "aria-label": this.nls('chartRender'), className: 'w-100 h-100', ref: this._chartContainer }))));
    }
}
