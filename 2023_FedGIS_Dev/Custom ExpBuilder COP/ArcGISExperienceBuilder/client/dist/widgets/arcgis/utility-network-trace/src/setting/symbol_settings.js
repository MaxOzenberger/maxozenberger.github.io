...
import { getZTopIndex } from './lib/style';
...
export default class SymbolSettings extends React.PureComponent {
    constructor(props) {
        super(props);
        this.jsonUtils = null;
        this.nls = (id) => {
        ...
        this.componentDidMount = () => {
            ...
            if (!this.state.apiLoaded) {
                loadArcGISJSAPIModules(["esri/symbols/support/jsonUtils"]).then((modules) => {
    ...
    render() {
        return (jsx("div", { style: { height: "100%", marginTop: "5px" } },
            jsx(SettingRow, { flow: "wrap" }, this.state.defaultSymbol && (jsx(SymbolSelector, { jimuSymbolType: JimuSymbolType.Point, css: getZTopIndex(this.props.theme), symbol: this.state.defaultSymbol, onPointSymbolChanged: this.onPointSymbolChanged.bind(this) })))));
    }
}
//# sourceMappingURL=symbol_settings.js.map