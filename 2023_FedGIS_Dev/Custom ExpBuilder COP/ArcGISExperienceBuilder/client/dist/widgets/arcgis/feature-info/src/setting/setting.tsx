...
import {
  ...
  UseDataSource, SqlExpression, OrderByOption, DataSourceComponent, FeatureLayerDataSource, SceneLayerDataSource
} from 'jimu-core'
import { Button, ButtonGroup, Dropdown, DropdownButton, DropdownMenu, DropdownItem, Checkbox, TextArea, DistanceUnits, LinearUnit, Select } from 'jimu-ui'
      ...
      styleContent = (
        <div>
          ...
          <SettingRow label={<FormattedMessage id='textColor' defaultMessage='Text color' />}>
            <ThemeColorPicker specificTheme={this.props.theme2} value={this.getStyleConfig().textColor} onChange={value => this.onStyleChanged('textColor', value)} />
          </SettingRow>
        </div>
      )
    }
        ...
        <div className='widget-setting-featureInfo'>
          ...
          <SettingSection title={this.props.intl.formatMessage({ id: 'general', defaultMessage: 'General' })}>
            ...
            <TextArea
              ...
              defaultValue={this.props.config.noDataMessage || this.props.intl.formatMessage({ id: 'noDeataMessageDefaultText', defaultMessage: defaultMessages.noDeataMessageDefaultText })}
