...
export function getStyleForEditHeader(theme) {
    return css `
    .layer-item-panel {
      .setting-header {
...
export function getInputSettingsStyle(theme) {
    return css `
  .formatLabel {
    width: 194px;
  }
...
export function getOutputSettingsStyle(theme) {
    return css `
  .add-conversion {
...
export function getAddressSettingsStyle(theme) {
    return css `
