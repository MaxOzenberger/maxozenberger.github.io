...
/** @jsx jsx */
import { React, jsx, ReactResizeDetector, classNames, utils } from 'jimu-core';
...
export default class Widget extends React.PureComponent {
    constructor(props) {
        ...
        this.displayImageInViewFlag = true;
        this.preserveToken = { token: '', server: '' };
        this.imagePointCheck = false;
        this.currentCoverageCheck = true;
        this.similarCoverageCheck = false;
        this.allCoverageCheck = false;
        this.coverageFlag = { imagePoints: false, similarCoverage: false, currentCoverage: true, allCoverage: true };
        this.sceneViewFlag = false;
        this.apiLocalState = false;
        this.serviceUrl = '';
        this.zoomToImageExtent = false; //#9678 issue fix
        this.nls = (id) => {
            ...
            if (jimuMapView) {
                ...
                if (this.graphicsLayer) {
                    if (this.mapView.type === '2d') {
                        ...
                        (_a = this.orientedViewer) === null || _a === void 0 ? void 0 : _a.setEnvironment('2D'); //#818
                    }
                    else {
                        ...
                        //#818
                        (_b = this.orientedViewer) === null || _b === void 0 ? void 0 : _b.setHeightModelInfo({ heightModel: (_c = this.mapView.heightModelInfo) === null || _c === void 0 ? void 0 : _c.heightModel, heightUnit: (_d = this.mapView.heightModelInfo) === null || _d === void 0 ? void 0 : _d.heightUnit }); // #670 issue
                        (_e = this.orientedViewer) === null || _e === void 0 ? void 0 : _e.setEnvironment('3D');
                    }
                }
                else {
                    if (this.mapView.type === '2d') {
                        ...
                        (_f = this.orientedViewer) === null || _f === void 0 ? void 0 : _f.setEnvironment('2D'); //#818
                    }
                    else {
                        this.graphicsLayer = new GraphicsLayer({
                            // id: "oi-graphicsLayer",
                        ...
                        //#818
                        (_g = this.orientedViewer) === null || _g === void 0 ? void 0 : _g.setHeightModelInfo({ heightModel: (_h = this.mapView.heightModelInfo) === null || _h === void 0 ? void 0 : _h.heightModel, heightUnit: (_j = this.mapView.heightModelInfo) === null || _j === void 0 ? void 0 : _j.heightUnit }); // #670 issue
                        (_k = this.orientedViewer) === null || _k === void 0 ? void 0 : _k.setEnvironment('3D');
                    }
                }
                ...
                this.mapPopupHandler2 = this.mapView.popup.watch('visible', (visible) => {
                    if (!visible && this.featureSelected) {
                        ...
                        if (document.getElementById('viewGraphicBtn'))
        ...
        this.loadOrientedImageryApi = () => {
            ...
            if (!this.props.oiApiLoaded) { //#1000
                window.orientedImagery.on('load', (loaded) => {
                    if (loaded) {
                        this.props.dispatch({
                            type: 'API_Loaded',
                            val: true
        ...
        this.loadOIViewer = () => {
            ...
            (_b = (_a = this.selectBtnRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.classList.remove('hide');
            (_d = (_c = this.selectBtnRef) === null || _c === void 0 ? void 0 : _c.current) === null || _d === void 0 ? void 0 : _d.classList.add('show');
            this.orientedViewer = window.orientedImagery.viewer(this.oiviewerRef.current);
            if (this.props.theme.darkTheme)
                window.orientedImagery.setTheme('dark');
            if (this.mapView.type === '3d') {
                this.orientedViewer.setHeightModelInfo({ heightModel: (_e = this.mapView.heightModelInfo) === null || _e === void 0 ? void 0 : _e.heightModel, heightUnit: (_f = this.mapView.heightModelInfo) === null || _f === void 0 ? void 0 : _f.heightUnit }); // #670 issue
        ...
        this.addOICItem = (url) => {
            ...
            esriRequest(url + '/data', {
                ...
                responseType: 'json'
            }).then((oicInfo) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (oicInfo && oicInfo.properties) {
                    ...
                    if (this.oicList[0]) {
                        ...
                        //#9678 issue fix
                        if (((_d = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.oic[0]) === null || _b === void 0 ? void 0 : _b.itemUrl) === null || _c === void 0 ? void 0 : _c.properties) === null || _d === void 0 ? void 0 : _d.DefaultSearchLocation) && ((_e = this.config.oic[0].itemUrl.properties.DefaultSearchLocation) === null || _e === void 0 ? void 0 : _e.x)) {
                        ...
                        else if ((_j = (_h = (_g = (_f = this.config) === null || _f === void 0 ? void 0 : _f.oic[0]) === null || _g === void 0 ? void 0 : _g.itemUrl) === null || _h === void 0 ? void 0 : _h.properties) === null || _j === void 0 ? void 0 : _j.DefaultImage) {
                            ...
                            const geoJSON = (_o = (_m = (_l = (_k = this.config) === null || _k === void 0 ? void 0 : _k.oic[0]) === null || _l === void 0 ? void 0 : _l.itemUrl) === null || _m === void 0 ? void 0 : _m.properties) === null || _o === void 0 ? void 0 : _o.GeoJSONFeatures;
                            if (geoJSON && geoJSON.type === 'FeatureCollection' && Object.hasOwnProperty.call(geoJSON, 'features') && geoJSON.features.length) {
                                ...
                                multiPoint = Projection.project(multiPoint, this.mapView.extent ? this.mapView.extent.spatialReference : this.mapView.spatialReference);
                            ...
                            execute.executeForExtent(url, query).then((response) => {
                                if (response.extent) {
                                    ...
                                    if ((!geometryEngine.intersects(this.mapView.extent, response.extent) || geometryEngine.within(response.extent, this.mapView.extent))) {
                                ...
                                if (response.data && response.data.extent) {
                                    if (response.data.extent.spatialReference.wkid === this.mapView.spatialReference.wkid &&
                                        ...
                                        geometryService.project(this.props.portalSelf.helperServices.geometry.url, params).then((geometry) => {
                                            this.graphicsLayer.fullExtent = geometry[0]; //#9677 issue fix
                                            if (!geometryEngine.intersects(this.mapView.extent, geometry[0]) ||
                                                geometryEngine.within(geometry[0], this.mapView.extent)) {
                                                this.mapView.goTo(geometry[0]);
                                            }
                                        });
                                    }
        ...
        this.searchImages = (point, objectId) => {
            var _a, _b;
            const url = (_a = this.state.config.oic[this.state.selectedOIC]) === null || _a === void 0 ? void 0 : _a.itemUrl;
            this.setState({
                showLoading: true
            });
            if (this.props.oiApiLoaded && url) { //#1000
                if (this.mapView.type === '2d') {
                    ...
                    this.orientedViewer.searchImages(point.toJSON(), url, {
                        maxDistance: (_b = Number(this.state.config.oic[this.state.selectedOIC].itemUrl.properties.MaxDistance)) !== null && _b !== void 0 ? _b : 1000,
                    ...
                    this.queryElevation(point).then((res) => {
                        ...
                        if (this.sceneViewFlag) {
                            ...
                            this.orientedViewer.searchImages(pointJSON, url, {
                                maxDistance: (_a = Number(this.state.config.oic[this.state.selectedOIC].itemUrl.properties.MaxDistance)) !== null && _a !== void 0 ? _a : 1000,
                                extent: this.mapView.extent.toJSON(),
        ...
        this.drawPointAndPolygons = (response) => __awaiter(this, void 0, void 0, function* () {
            this.setState({
                showLoading: false
            });
            this.graphicsLayer.graphics.removeAll();
            if (!response.error) {
                ...
                if (this.mapView.type === '2d') {
                    ...
                    // }
                    if (this.zoomToImageExtent) { //#9678 issue fix
                        yield this.queryElevation(new Point(response.imageSourcePoints[0])).then((res) => {
                            this.avgGroundElevation = res.geometry.z;
                        });
                    }
                    let multiPoint = this.createMultiPoint({ geometries: response.imageSourcePoints.concat(response.point), type: 'point' });
                    const multiPoint2 = this.createMultiPoint({ geometries: response.coverageFrustums, type: 'frustum' });
        ...
        this.drawCoveragePolygons = (polygons, imageID) => {
            const coveragePolygons = []; //#9677 issue fix
            let currentCoverageGraphic;
            for (let a = 0; a < polygons.length; a++) {
                if (polygons[a]) { //#625
                    if (imageID === polygons[a].imageID) {
                        currentCoverageGraphic = (new Graphic({
        ...
        this.drawImageSourcePoints = (points, imageID) => {
        ...
        this.updateCoveragePolygon = (imageProperties) => {
        ...
        this.updateGraphics = (image) => {
            ...
            if (this.mapView.type === '3d') {
                    ...
                    if (loopRunner < 4) {
                        if (SYMBOLS.includes(graphic.symbol.style)) {
                            if (graphic.symbol.style === 'circle') {
                                if (graphic.attributes.imageID === image.imageID) {
                ...
                if (graphics['simple-line']) { //#9677 issue fix
                    const currentGeometry = graphics.circle;
                    graphics['simple-line'].geometry.paths[0][1] = [currentGeometry.x, currentGeometry.y, currentGeometry.z];
                ...
                if (crossGraphic) {
                    this.graphicsLayer.add(crossGraphic);
                }
                if (diamondGraphic) {
                    this.graphicsLayer.add(diamondGraphic);
                }
            }
            this.activeImageID = image.imageID;
        };
        this.createCoverageArea = (value) => {
                            ...
                            if (this.mapView.type === '2d') {
                                ...
                                this.queryElevation(multiPoint).then((result) => {
                                    ...
                                    for (let gm = 0; gm < response.coverageMap.rings.length; gm++) {
                                        for (let mb = 0; mb < response.coverageMap.rings[gm].length; mb++) {
        ...
        this.drawFrustums = (frustums, imageID) => {
            const coverageFrustums = []; //#9677 issue fix
            let currentCoverageFrustum;
        ...
        this.showPointOnMap = (geometry) => {
            ...
            if (this.mapView.type === '2d') {
                ...
                if (!this.graphicExists) {
                    this.graphicsLayer.add(new Graphic({ geometry: geometry, symbol: this.diamondSymbol }));
                    for (let v = this.graphicsLayer.graphics.length - 1; v >= 0; v--) {
                        if (((_a = this.graphicsLayer.graphics.getItemAt(v).symbol) === null || _a === void 0 ? void 0 : _a.style) === 'circle' && this.graphicsLayer.graphics.getItemAt(v).attributes.imageID === this.activeImageID) {
                            const g = this.graphicsLayer.graphics.getItemAt(v).geometry.clone(); //#9677 issue fix
                    ...
                    for (let v = this.graphicsLayer.graphics.length - 1; v >= 0; v--) {
                        if (((_b = this.graphicsLayer.graphics.getItemAt(v).symbol) === null || _b === void 0 ? void 0 : _b.style) === 'diamond') {
                            this.graphicsLayer.graphics.getItemAt(v).geometry = geometry; //#9677 issue fix
                            break;
                        }
                    }
                    for (let v = this.graphicsLayer.graphics.length - 1; v >= 0; v--) {
                        if (((_c = this.graphicsLayer.graphics.getItemAt(v).symbol) === null || _c === void 0 ? void 0 : _c.type) === 'simple-line') { //#9677 issue fix
        ...
        this.turningOnOffFeatures = (selectedFeatures, state) => {
        ...
        this.selectFeature = (featureJson) => {
        ...
        this.showAttributeWindow = (layer, graphic, objectId, uniqueValueField) => {
        ...
        this.findImageInCatalog = (imgUrn, graphic, serviceUrl, graphicId) => {
        ...
        this.openImageInViewer = () => {
            ...
            if (this.selectedGraphicProperties && this.props.oiApiLoaded) { //#1000
                ...
                if (this.selectedGraphicProperties.geometry.type === 'point') {
                    point = this.selectedGraphicProperties.geometry;
                }
                else if (this.selectedGraphicProperties.geometry.type === 'polygon') {
                    point = this.selectedGraphicProperties.geometry.centroid;
                }
                else {
                    point = this.selectedGraphicProperties.geometry.extent.center;
                }
                point.z = 0;
            ...
            return promiseUtils.create(function (resolve, reject) {
                if (att) {
                    ...
                    this.queryElevation(point).then((result) => {
                        ...
                        this.mapView.goTo(cam, { easing: 'linear' }).then(() => {
                            resolve();
                        });
                    });
                }
        ...
        this.zoomImageInView = (scaleFactor, x, y) => {
            const camera = this.mapView.camera.clone();
        ...
        this.updateViewCamera = (cameraProperties) => {
            const camera = this.mapView.camera.clone();
        ...
        this.updateImageInView = (response) => {
        ...
        this.changeLayersVisibility = (flag) => {
            // if (!flag) {
        ...
        this.disableZoom = () => {
            const zoomNode = document.getElementsByClassName('esri-component esri-zoom esri-widget');
            if (zoomNode.length) {
        ...
        this.setupResizeHandle = (width, height) => {
            var _a;
            if (height && width) { //#840
                this.oiviewerRef.current.style.height = '100%';
                this.oiviewerRef.current.style.width = '100%';
                (_a = this.orientedViewer) === null || _a === void 0 ? void 0 : _a.resize();
            }
        };
        this.state = {
            selectedOIC: '',
    ...
    componentDidMount() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            (_b = (_a = this.selectBtnRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.classList.add('hide');
            this.setState({
                config: {
                    oic: []
                }
            ...
            this.oicList = [];
            if (this.props.token) {
                if (!this.preserveToken.token)
                    this.preserveToken.token = this.props.token;
                if (!this.preserveToken.server)
                    this.preserveToken.server = this.props.portalUrl;
            }
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.state !== 'CLOSED') {
            ...
            if (((_a = this.props.config.oicList) === null || _a === void 0 ? void 0 : _a.length) && !this.overviewLayer && this.mapView)
                this.loadOIC();
            else if (((_b = this.props.config.oicList) === null || _b === void 0 ? void 0 : _b.length) && this.overviewLayer && this.mapView) {
            ...
            if (document.querySelectorAll('link[id="orientedImagery-web-dark"').length > 0) {
                if (this.props.theme.darkTheme)
                    ...
                    window.orientedImagery.setTheme('light');
            }
        }
        //#9678 issue fix
    ...
    componentWillUnmount() {
        var _a, _b, _c, _d, _e;
        (_a = this.mapClickEventHandler) === null || _a === void 0 ? void 0 : _a.remove();
        (_b = this.mapPopupHandler1) === null || _b === void 0 ? void 0 : _b.remove();
        (_c = this.mapPopupHandler2) === null || _c === void 0 ? void 0 : _c.remove();
        //#7151
        (_d = this.mapView) === null || _d === void 0 ? void 0 : _d.map.remove(this.graphicsLayer);
        (_e = this.mapView) === null || _e === void 0 ? void 0 : _e.map.remove(this.overviewLayer);
    }
    ...
    render() {
        var _a;
        let content = null;
        const classes = classNames('oi-btn-css', 'oi-btn-css-clear', 'oi-btn-css-grouped', 'oi-widget-selectBtn', this.props.pointBool ? 'oi-widget-selectBtnSelected' : '');
        if (!this.isConfigured()) {
            //#7139
            // this.oiviewerRef.current.classList.add('hide');
            this.destroyOIViewer();
            content = jsx("div", { className: 'widget-orientedimagery' },
                jsx(WidgetPlaceholder, { icon: oiIcon, message: this.props.intl.formatMessage({ id: '_widgetLabel', defaultMessage: defaultMessages._widgetLabel }), widgetId: this.props.id }));
        }
        else {
            content = jsx("div", { className: 'widget-orientedimagery' },
                jsx(Button, { ref: this.selectBtnRef, "aria-label": this.props.pointBool ? this.nls('toggleButtonOn') : this.nls('toggleButtonOff'), title: this.props.pointBool ? this.nls('toggleButtonOn') : this.nls('toggleButtonOff'), className: classes, onClick: this.toggleIcon.bind(this) },
                    jsx("svg", { xmlns: 'http://www.w3.org/2000/svg', width: '32', height: '32', viewBox: '0 0 32 32', className: 'svg-icon' },
                        jsx("path", { d: 'M15.999 0C11.214 0 8 1.805 8 6.5v17l7.999 8.5L24 23.5v-17C24 1.805 20.786 0 15.999 0zM16 14.402A4.4 4.4 0 0 1 11.601 10a4.4 4.4 0 1 1 8.798 0A4.4 4.4 0 0 1 16 14.402z' }))),
                ...
                jsx("div", { ref: this.oiviewerRef },
                    jsx("button", { className: 'oi-btn-css oi-btn-css-transparent', style: { display: 'none', marginTop: '5px' }, id: 'viewGraphicBtn' }, this.nls('viewImage')),
                    jsx(ReactResizeDetector, { handleWidth: true, handleHeight: true, onResize: this.setupResizeHandle })),
                this.state.showLoading && jsx(Loading, { type: LoadingType.Donut }));
        }
        return jsx("div", { css: getStyle(this.props.theme), className: 'jimu-widget' }, content);
    }
}
