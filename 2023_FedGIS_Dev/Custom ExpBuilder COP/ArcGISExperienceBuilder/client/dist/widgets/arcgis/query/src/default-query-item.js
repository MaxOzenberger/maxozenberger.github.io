import { CreateToolType, UnitType, SpatialRelation, ListDirection, PagingType, FieldsType, SymbolType } from './config';
export const DEFAULT_QUERY_ITEM = {
    icon: null,
    displayLabel: true,
    sqlExprObj: null,
...
//# sourceMappingURL=default-query-item.js.map