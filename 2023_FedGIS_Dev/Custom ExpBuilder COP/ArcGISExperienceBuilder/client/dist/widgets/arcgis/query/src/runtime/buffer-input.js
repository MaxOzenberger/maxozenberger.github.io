...
export function BufferInput(props) {
    ...
    return (jsx(React.Fragment, null,
        jsx(NumericInput, { "aria-label": getI18nMessage('bufferDistance'), className: 'mr-1', value: d, onChange: handleDistanceChange, onAcceptValue: handleDistanceAccepted }),
        jsx(Select, { "aria-label": getI18nMessage('unit'), value: u, onChange: handleBufferUnitChange }, Object.values(UnitType).map((value) => (jsx("option", { key: value, value: value }, getI18nMessage(`unit_${value}`)))))));
}
//# sourceMappingURL=buffer-input.js.map