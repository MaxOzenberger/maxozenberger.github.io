...
export const useLineOfSight = (props) => {
    const { onUpdated } = props;
    const widgetRef = React.useRef(null);
    // Loading for API btn disabled state, before inited ,#10112
    const [widgetReadyState, setWidgetReadyState] = React.useState(false);
    const [viewModelReadyState, setViewModelReadyState] = React.useState(false);
    React.useEffect(() => {
