...
jest.mock('jimu-ui', () => {
    return Object.assign(Object.assign({}, jest.requireActual('jimu-ui')), { ImageWithParam: jest.fn(() => React.createElement("div", { "data-testid": 'imageWithParamTest' })) });
});
jest.mock('../src/runtime/components/image-gallery', () => {
    return Object.assign(Object.assign({}, jest.requireActual('../src/runtime/components/image-gallery')), { ImageGallery: jest.fn(() => React.createElement("div", { "data-testid": 'imageGalleryTest' })) });
});
jest.mock('../src/runtime/components/attachment-component', () => {
    return Object.assign(Object.assign({}, jest.requireActual('../src/runtime/components/attachment-component')), { AttachmentComponent: jest.fn(() => React.createElement("div", { "data-testid": 'attachmentTest' })) });
});
jest.mock('../src/runtime/components/symbol-component', () => {
    return Object.assign(Object.assign({}, jest.requireActual('../src/runtime/components/symbol-component')), { SymbolComponent: jest.fn(() => React.createElement("div", { "data-testid": 'symbolTest' })) });
});
...
describe('image widget test, use ds', function () {
    ...
    it('should render different component', () => {
        const { getByTestId, rerender } = render(React.createElement(Widget, Object.assign({ widgetId: 'imageTest1' }, props)));
        ...
        rerender(React.createElement(Widget, Object.assign({ widgetId: 'imageTest1' }, newProps)));
...
describe('image widget test', function () {
    describe('default config', function () {
        ...
        it('image widget should be render', () => {
            const { getBySelector } = render(React.createElement(Widget, { config: config }));
