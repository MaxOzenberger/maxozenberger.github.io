...
export const Placeholder = (props) => {
    ...
    return jsx("div", { className: classNames('placeholder-container w-100 h-100', className), css: style },
        jsx(WidgetPlaceholder, { iconSize: 'large', icon: icon }),
        showMessage && jsx(Alert, { form: messageType, withIcon: true, size: 'small', type: 'warning', text: message }));
};
