...
`;
export const ColorsSelector = (props) => {
    const { className, style, onChange } = props;
    const translate = hooks.useTranslate(defaultMessages);
    return (jsx(Dropdown, { style: style, className: classNames('colors-selector', className) },
        jsx(DropdownButton, { size: 'sm', title: translate('applyColorsTip') }, translate('applyColors')),
        jsx(DropdownMenu, { showArrow: true, css: styles },
            jsx("div", null, COLORS_SET.map((colors, index) => {
                return jsx(DropdownItem, { className: 'my-1', key: index },
                    jsx(ColorStrip, { colors: colors, onChange: onChange }));
            })))));
};
//# sourceMappingURL=colors-selector.js.map