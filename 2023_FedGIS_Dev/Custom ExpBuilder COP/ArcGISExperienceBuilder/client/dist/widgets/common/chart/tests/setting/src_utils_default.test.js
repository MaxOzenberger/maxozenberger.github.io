...
import { getThemeColorVariables, getSeriesFillColor, generateRandomThemeColor, getDefaultTextColor, getDefaultColor, getTextSymbol, DefaultTextSymbol, DefaultLineSymbol, getLineSymbol, getFillSymbol, DefaultFillSymbol, getChartText, SeriesColors, DefaultColor, DefaultTextColor } from '../../src/utils/default';
...
describe('src/utils/default', () => {
    ...
    it('getDefaultTextSymbol', () => {
        expect(getTextSymbol('foo')).toEqual(Object.assign(Object.assign({}, DefaultTextSymbol), { text: 'foo' }));
    });
    it('getLineSymbol', () => {
        expect(getLineSymbol()).toEqual(DefaultLineSymbol);
    });
    it('getFillSymbol', () => {
        expect(getFillSymbol()).toEqual(Object.assign(Object.assign({}, DefaultFillSymbol), { color: 'var(--dark)' }));
        expect(getFillSymbol(SeriesColors[1])).toEqual(Object.assign(Object.assign({}, DefaultFillSymbol), { color: SeriesColors[1] }));
    });
    it('getChartText', () => {
        expect(getChartText('foo')).toEqual({
            type: WebChartTypes.Text,
            visible: true,
            content: Object.assign(Object.assign({}, DefaultTextSymbol), { text: 'foo' })
        });
...
//# sourceMappingURL=src_utils_default.test.js.map