...
jest.mock('../../src/utils/common', () => {
    return Object.assign(Object.assign({}, jest.requireActual('../../src/utils/common')), { getFieldSchema: field => ({ field, alias: `${field}-1` }) });
});
const makeDummyRecord = (attribute) => {
    return {
        getData: () => attribute,
...
//# sourceMappingURL=serial-utils.test.js.map