import { css, polished, AppMode, utils } from 'jimu-core';
import { DirectionType, LIST_CARD_PADDING, PageStyle, DS_TOOL_BOTTOM_PADDING, DS_TOOL_H, BOTTOM_TOOL_TOP_PADDING, BOTTOM_TOOL_H, COMMON_PADDING, ListLayoutType } from '../../config';
export const listStyle = utils.memoize(function (options) {
    ...
    &.list-container {
      ...
      .editing-mask-list {
        position: absolute;
        top: ${layoutType !== ListLayoutType.Column && hasRecords
        ? currentCardSize.height + topToolsH
        : topToolsH}px;
        left: ${layoutType === ListLayoutType.Column && hasRecords
...
export function getStyle(props, isEditing, showBottomTool) {
    ...
    ${'&.list-widget-' + id} {
      ...
      .refresh-loading-con {
        ...
        .auto-refresh-loading {
          background: ${polished.rgba((_c = (_b = (_a = theme.colors) === null || _a === void 0 ? void 0 : _a.palette) === null || _b === void 0 ? void 0 : _b.dark) === null || _c === void 0 ? void 0 : _c[100], 0.2)};
...
export function getToolsPopperStyle(props) {
    const { theme } = props;
    return css `
    & {
...
export function getSearchToolStyle(props) {
    const { theme } = props;
    return css `
    .close-search {
...
export function getTopToolStyle(props, showTopTools) {
    return css `
    .list-data-action {
      & {
