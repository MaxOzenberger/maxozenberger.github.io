/** @jsx jsx */
import { React, RepeatedDataSourceProvider, jsx, css, AppMode, utils, LayoutItemType, appActions, Immutable, ReactRedux, classNames } from 'jimu-core';
import { ListGroupItem, styleUtils } from 'jimu-ui';
import { Status, SelectionModeType, LIST_CARD_MIN_SIZE, ListLayout, ListLayoutType } from '../../config';
...
class _ListCardEditor extends ListCard {
    constructor(props) {
        ...
        this.getCopyDropdownItems = (showBreak) => {
            ...
            let linkedToSelect = cardConfigs[Status.Selected].selectionMode !== SelectionModeType.None;
            ...
            const isShowApplyToHover = ((_a = cardConfigs[Status.Hover]) === null || _a === void 0 ? void 0 : _a.listLayout) !== (ListLayout === null || ListLayout === void 0 ? void 0 : ListLayout.AUTO);
            const isShowApplyToSelected = ((_b = cardConfigs[Status.Selected]) === null || _b === void 0 ? void 0 : _b.listLayout) !== (ListLayout === null || ListLayout === void 0 ? void 0 : ListLayout.AUTO);
            const syncToHover = () => {
            ...
            const syncToSelected = () => {
                if (cardConfigs[Status.Selected].selectionMode !== SelectionModeType.None) {
                    ...
                    items.push({
                        ...
                        event: evt => {
                            this.handleCopyTo(evt, Status.Selected, selectedLayoutItem, linkedToSelect);
                        }
                    });
                }
            };
    ...
    `;
            switch (layoutType) {
                case ListLayoutType.Column:
                    handlers.push(jsx("span", { key: '10', className: 'list-card-rnd-resize-left-line', css: [handle, rightSideLine] }));
                    handlers.push(jsx("span", { key: '4', className: 'list-card-rnd-resize-right', css: [handle, sideHandle, rightSideCursor] }));
                    break;
                case ListLayoutType.Row:
                    handlers.push(jsx("span", { key: '9', className: 'list-card-rnd-resize-bottom-line', css: [handle, bottomSideLine] }));
                    handlers.push(jsx("span", { key: '6', className: 'list-card-rnd-resize-bottom', css: [handle, sideHandle, bottomSideCursor] }));
                    break;
    ...
    `;
            ...
            return (showTools &&
                ...
                (cardConfigs[Status.Hover].enable ||
                    cardConfigs[Status.Selected].selectionMode !==
                        SelectionModeType.None) && (jsx(BuilderPopper, { placement: 'left-start', trapFocus: false, autoFocus: false, css: css `
        ...
        this.getCardMenuElement = () => {
            ...
            const listLayout = ((_a = cardConfigs[builderStatus]) === null || _a === void 0 ? void 0 : _a.listLayout) || ListLayout.CUSTOM;
            ...
            const CardMenu = withBuilderTheme(theme => {
                return (jsx("div", { className: 'status-group d-flex flex-column align-items-center p-2', css: this.getCardToolsStyle(theme) },
                    ...
                    cardConfigs[Status.Hover].enable && (jsx(BuilderButton, { active: builderStatus === Status.Hover, className: 'mt-1', onClick: evt => this.handleBuilderStatusChange(evt, Status.Hover) }, this.formatMessage('hover'))),
                    cardConfigs[Status.Selected].selectionMode !==
                        SelectionModeType.None && (jsx(BuilderButton, { active: builderStatus === Status.Selected, className: 'mt-1', onClick: evt => this.handleBuilderStatusChange(evt, Status.Selected) }, this.formatMessage('selected'))),
                    isShowCopyPopper && (jsx(BuilderDropDown, { className: 'mt-1 w-100', toggleIsIcon: true, toggleTitle: syncTitle, toggleType: 'default', direction: 'left', toggleArrow: false, toggleContent: theme => (showBreak ? jsx(SyncOnOutlined, { size: 16 }) : jsx(SyncOffOutlined, { size: 16 })), modifiers: applyPopperModifiers, items: syncItems }))));
            });
    ...
    render() {
        ...
        return (jsx(RepeatedDataSourceProvider, { data: this.providerData },
            jsx(ListGroupItem, { active: selectable && active, css: this.getStyle(builderStatus), style: Object.assign(Object.assign({}, cardContentStyle), listStyle), className: classNames('surface-1', `list-card-${widgetId}`), onClick: this.handleItemClick, role: 'listCardEditor' },
                isShowMask && jsx("div", { className: 'card-editor-mask position-absolute' }),
                didMount && this.renderCardTools(),
                jsx("div", { className: 'list-card-content d-flex', style: mergedStyle, css: this.getEditorStyle(), ref: this.resizeRef },
                    jsx(LayoutEntry, { isItemAccepted: this.isItemAccept, isRepeat: true, layouts: showLayout, isInWidget: true }),
                    isEditing &&
                        !selectionIsInList &&
                        !isLockItemRatio &&
                        this._renderAction()))));
...
//# sourceMappingURL=list-card-editor.js.map