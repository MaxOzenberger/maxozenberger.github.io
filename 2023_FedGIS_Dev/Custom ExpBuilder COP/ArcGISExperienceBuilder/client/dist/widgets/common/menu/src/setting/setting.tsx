        ...
        {type === 'drawer' && (
          <SettingRow label={translate('location')} flow='no-wrap'>
            <Select
              ...
              value={anchor}
              onChange={evt =>
                onSettingConfigChange(['standard', 'anchor'], evt.target.value)
              }
            >
          ...
          <React.Fragment>
            <SettingRow label={translate('icon')} flow='no-wrap'>
              <IconPicker
                ...
                onChange={icon =>
                  onSettingConfigChange(['standard', 'icon'], icon)
                }
      ...
      <SettingSection title={translate('appearance')}>
        ...
        <SettingRow flow='no-wrap' label={translate('alignment')}>
          <TextAlignment
            textAlign={textAlign}
            onChange={value =>
              onSettingConfigChange(['standard', 'textAlign'], value)
            }
          />
        </SettingRow>
        ...
        <SettingRow flow='no-wrap' label={translate('showIcon')}>
          <Switch
            checked={showIcon}
            onChange={(_, value) =>
              onSettingConfigChange(['standard', 'showIcon'], value)
            }
          />
        </SettingRow>
      </SettingSection>
            ...
            {type !== 'drawer' && (
              <SettingRow label={translate('background')} flow='no-wrap'>
                <ThemeColorPicker
                  ...
                  onChange={value =>
                    onSettingConfigChange(['variant', 'root', 'bg'], value)
                  }
                />
              </SettingRow>
            )}
            ...
            {type === 'drawer' && (
              <SettingRow label={translate('background')} flow='no-wrap'>
                <ThemeColorPicker
                  ...
                  value={paper?.bg}
                  onChange={value =>
                    onSettingConfigChange(['paper', 'bg'], value)
                  }
                />
              </SettingRow>
            )}
