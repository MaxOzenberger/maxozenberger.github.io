...
describe('<SettingAdvanced />', () => {
    ...
    describe('given themeBoxDataItems prop', () => {
        const renderContent = (React.createElement(SettingAdvanced, { variant: themeBoxStyle, onChange: mockOnSettingConfigChange }));
        it('Tab has defaultActive prop properly provided', () => {
            const { container } = widgetRender(getAppStore(), mockTheme)(renderContent);
...
//# sourceMappingURL=setting-advanced.test.js.map