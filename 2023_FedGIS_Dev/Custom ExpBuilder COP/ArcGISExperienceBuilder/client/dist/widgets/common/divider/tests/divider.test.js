...
import { wrapWidget, withStoreThemeIntlRender, mockTheme, getInitState, initGlobal } from 'jimu-for-test';
...
describe('divider widget test', function () {
    describe('default config', function () {
        ...
        it('divider widget should be render', () => {
            const { getByTestId } = withStoreThemeIntlRender(STORE, mockTheme)(React.createElement(Widget, null));
        ...
        it('test divider color', () => {
            ...
            expect(style === null || style === void 0 ? void 0 : style.borderBottom).toBe('2px solid #000');
        });
    });
});
function getStore() {
