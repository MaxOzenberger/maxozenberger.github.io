  ...
  `;
    ...
    &:before {
      ...
      background-image: repeating-linear-gradient(
        to right,
        ${color} 0,
        ${color} ${getSizeByRatio(size, 1)},
        transparent 0,
        transparent ${getSizeByRatio(size, 6)}
      );
    }
    &:after {
      position: absolute;
...
export function getPointStyle(size, color, direction = Direction.Horizontal, isPointStart = true) {
    ...
    const position = 0;
    const isHorizontal = direction === Direction.Horizontal;
    let pointHorizontalCss = { None: 'None' };
    let pointVerticalCss = { None: 'None' };
  ...
  `;
    ...
    & {
      width: ${getSizeByRatio(size, 0.71)};
      height: ${getSizeByRatio(size, 0.71)};
      background-color: ${color};
  ...
  `;
    ...
    & {
      ...
      left: ${isPointStart ? position : 'unset'};
      right: ${!isPointStart ? `-${getSizeByRatio(size, 0.5)}` : 'unset'};
      top: 50%;
      transform: translateY(-50%);
    }
  `;
    ...
    & {
      ...
      border-style: solid;
      border-color: transparent ${color} transparent transparent;
      left: ${isPointStart ? `-${getSizeByRatio(size, 0.5)}` : 'unset'};
      right: ${!isPointStart ? position : 'unset'};
      top: 50%;
      transform: translateY(-50%);
    }
  `;
    ...
    & {
      width: ${getSizeByRatio(size, 0.8)};
      height: ${getSizeByRatio(size, 0.8)};
      left: ${isPointStart ? `${getSizeByRatio(size, 0.2)}` : 'unset'};
      right: ${!isPointStart ? `-${getSizeByRatio(size, 0.2)}` : 'unset'};
      top: 50%;
  ...
  `;
    ...
    & {
      ...
      top: ${isPointStart ? `-${getSizeByRatio(size, 0.5)}` : 'unset'};
      bottom: ${!isPointStart ? position : 'unset'};
      left: 50%;
      transform: translateX(-50%);
    }
  `;
    ...
    & {
      ...
      top: ${isPointStart ? position : 'unset'};
      bottom: ${!isPointStart ? `-${getSizeByRatio(size, 0.5)}` : 'unset'};
      left: 50%;
      transform: translateX(-50%);
    }
  `;
  ...
  `;
    ...
    pointHorizontalCss = Object.assign(Object.assign({}, pointHorizontalCss), horizontalCss);
    pointVerticalCss = Object.assign(Object.assign({}, pointVerticalCss), verticalCss);
    return isHorizontal ? pointHorizontalCss : pointVerticalCss;
}
function getSizeByRatio(size, spaceRatio = 1.5, minSize = null) {
    if (!size)
        return '0px';
...
export function getDividerLineStyle(isHorizontal, isPointStartEnable, isPointEndEnable, pointStartSize, pointEndSize) {
...
//# sourceMappingURL=template-style.js.map