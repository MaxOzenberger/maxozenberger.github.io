/** @jsx jsx */
import { jsx, polished, css } from 'jimu-core';
import { useTheme } from 'jimu-theme';
import { Icon, Button, hooks } from 'jimu-ui';
...
const Effect = (props) => {
    ...
    const { active, onClick, icon } = props;
    const theme = useTheme();
    const primary600 = (_c = (_b = (_a = theme.colors) === null || _a === void 0 ? void 0 : _a.palette) === null || _b === void 0 ? void 0 : _b.primary) === null || _c === void 0 ? void 0 : _c[600];
    const light200 = (_f = (_e = (_d = theme.colors) === null || _d === void 0 ? void 0 : _d.palette) === null || _e === void 0 ? void 0 : _e.light) === null || _f === void 0 ? void 0 : _f[200];
    const style = css `
    ...
    outline: ${active ? `2px solid ${primary600}` : 'unset'};
  `;
    return (jsx("div", { css: style },
        jsx(Button, { "aria-label": props['aria-label'], icon: true, type: 'tertiary', size: 'sm', onClick: onClick, "aria-pressed": active },
            jsx(Icon, { icon: icon, size: 'l' }))));
};
const style = css `
  width: 100%;
  .line-one,
...
export const Effects = (props) => {
    ...
    return (jsx("div", { css: style, role: 'group' },
        jsx("div", { className: 'line-one' }, EFFECTS1.map(([effect, icon], index) => {
            return jsx(Effect, { "aria-label": index === 0 ? translate('none') : translate('effect') + index, key: index, icon: icon, active: effect ? effect === value : !value, onClick: () => onChange(effect) });
        })),
        jsx("div", { className: 'line-two' }, EFFECTS2.map(([effect, icon], index) => {
            return jsx(Effect, { "aria-label": translate('effect') + (5 + index), key: index, icon: icon, active: effect === value, onClick: () => onChange(effect) });
        }))));
};
