...
describe('filter widget', function () {
    ...
    it('utils - getUpdatedEndTimeByStepLength', function () {
        ...
        const endTimeVirtual = getUpdatedEndTimeByStepLength({ val: 1, unit: 'year' }, startTimeVirtual, new Date(2020, 8, 1, 8, 0, 0).getTime());
        ...
        // year
        const stepLengthY1 = { val: 1, unit: 'year' };
        ...
        const stepLengthY2 = { val: 2, unit: 'year' };
        ...
        // month
        const stepLengthM = { val: 1, unit: 'month' };
        ...
        const stepLengthM2 = { val: 2, unit: 'month' };
        ...
        // day
        const stepLengthD1 = { val: 1, unit: 'day' };
        ...
        const stepLengthD2 = { val: 7, unit: 'day' };
        ...
        // hour
        const stepLengthH1 = { val: 1, unit: 'hour' };
        ...
        const stepLengthH2 = { val: 8, unit: 'hour' };
        ...
        // minute
        const stepLengthm1 = { val: 1, unit: 'minute' };
        ...
        const stepLengthm2 = { val: 10, unit: 'minute' };
