import { css, getAppStore, polished } from 'jimu-core';
export function getStyle(theme, mobileFlag, partProps) {
    var _a, _b, _c, _d, _e, _f;
    const { id, enableDataAction, isHeightAuto, isWidthAuto } = partProps;
    const themeName = (_b = (_a = getAppStore().getState()) === null || _a === void 0 ? void 0 : _a.appConfig) === null || _b === void 0 ? void 0 : _b.theme;
    ...
    ${'&.table-widget-' + id} {
      ...
      .refresh-loading-con {
        ...
        .auto-refresh-loading {
          background: ${polished.rgba((_e = (_d = (_c = theme.colors) === null || _c === void 0 ? void 0 : _c.palette) === null || _d === void 0 ? void 0 : _d.dark) === null || _e === void 0 ? void 0 : _e[100], 0.2)};
          color: ${(_f = theme.colors) === null || _f === void 0 ? void 0 : _f.black};
...
export function getSuggestionStyle(suggestionWidth) {
    return css `
    & {
