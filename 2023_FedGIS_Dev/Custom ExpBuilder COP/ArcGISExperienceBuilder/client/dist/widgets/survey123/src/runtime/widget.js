/** @jsx jsx */
import { React, DataSourceManager, SessionManager, DataSourceStatus, Immutable, getAppStore, DataSourceTypes, portalUrlUtils, jsx, moduleLoader, semver } from 'jimu-core';
import { WidgetPlaceholder } from 'jimu-ui';
import { ArcGISDataSourceTypes, JimuMapViewComponent } from 'jimu-arcgis';
...
export default class Widget extends React.PureComponent {
    ...
    constructor(props) {
        ...
        this._dsManager = DataSourceManager.getInstance();
        ...
        this.onActiveViewChange = (jimuMapView) => {
            if (jimuMapView && jimuMapView.view) {
                this._mapView = jimuMapView.view;
                this._mapView.when(() => {
    ...
    getClientId() {
        ...
        else if ((_b = (_a = getAppStore().getState().appConfig) === null || _a === void 0 ? void 0 : _a.attributes) === null || _b === void 0 ? void 0 : _b.clientId) {
    ...
    renderDS() {
        ...
        if (dsId && rootDsId && this.isDsConfigured()) {
            ...
            //   }
            // </DataSourceComponent>
            return jsx(JimuMapViewComponent, { useMapWidgetId: (_a = this.props.useMapWidgetIds) === null || _a === void 0 ? void 0 : _a[0], onActiveViewChange: this.onActiveViewChange });
        }
        return jsx("div", null);
    }
    /**
    ...
    render() {
         ...
         */
        if (!webformUrl) {
            result = jsx("div", { className: "survey123__noSurvey" },
                jsx(WidgetPlaceholder, { icon: WidgetIcon, message: this.props.intl.formatMessage({ id: '_widgetLabel', defaultMessage: defaultMessages._widgetLabel }), widgetId: "" }));
        }
        else {
            if (!this.domId) {
                this.updateDomId();
            }
            result = jsx("div", { className: "survey123__webform" },
                jsx("div", { className: "embed-container", id: this.domId }));
        }
        /**
         * html
         */
        return jsx("div", { css: getStyle(this.props.theme), className: "survey123" },
            result,
            /*
             * render ds
             */
