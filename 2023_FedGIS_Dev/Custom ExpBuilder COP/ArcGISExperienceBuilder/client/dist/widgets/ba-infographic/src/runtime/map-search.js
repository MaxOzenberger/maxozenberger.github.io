...
export default class MapSearch {
     ...
     */
    static registerCallbacks(widgetId, mapWidgetId, view, searchResultCallback, searchClearCallback, mapActionsContext) {
        let mapData;
    ...
    static notifySearchResults(mapData, details) {
