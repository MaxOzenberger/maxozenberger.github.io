 ...
 * @ignore
 */
export declare enum ArcGISDataSourceTypes {
    Map = "MAP",
    WebMap = "WEB_MAP",
    WebScene = "WEB_SCENE"
}
...
export declare const AllDataSourceTypes: {
    ...
    SimpleLocal: DataSourceTypes.SimpleLocal;
    CSV: DataSourceTypes.CSV;
    FeatureLayer: DataSourceTypes.FeatureLayer;
    SceneLayer: DataSourceTypes.SceneLayer;
    GroupLayer: DataSourceTypes.GroupLayer;
    FeatureService: DataSourceTypes.FeatureService;
    MapService: DataSourceTypes.MapService;
    SceneService: DataSourceTypes.SceneService;
};
/**
* All data source types, including types from jimu-core and jimu-arcgis.
* The variable is only used as `type`, e.g. let types: AllDataSourceTypes[].
*/
export declare type AllDataSourceTypes = DataSourceTypes | ArcGISDataSourceTypes;
/**
...
export declare type TimeExtent = number | [number, number];
 ...
 */
export declare type ArcGISFolderLayer = __esri.MapImageLayer | __esri.TileLayer | __esri.GroupLayer | __esri.Sublayer;
/**
