...
import { IMState, AppContext, AppRuntimeInfo, IMJimuMapViewInfo, SectionNavInfo, IMDataSourceInfo, IMMapWidgetInfo, DialogInfos, LoadAppConfigError } from './types/state';
import { Selection, ClipboardItem, LayoutInfo } from './types/layout';
import { AppMode, BrowserSizeMode, PagePart, LoadingType, PortalInfo } from './types/common';
...
export declare enum ActionKeys {
    ...
    ExtensionRegistered = "EXTENSION_REGISTERED",
    AppConfigLoaded = "APPCONFIG_LOADED",
    AppConfigChanged = "APPCONFIG_CHANGED",
    LoadAppConfigFailed = "LOAD_APPCONFIG_FAILED",
...
export interface LoadAppConfigFailedAction {
...
export interface DataSourceSourceVersionChangeAction {
...
export interface SetupHoverPreviewAction {
...
export interface AddToRegisterClientIdListAction {
    type: ActionKeys.AddToRegisterClientIdList;
    portalUrl: string;
    needToSignIn?: boolean;
    serviceUrl?: string;
}
export interface RemoveFromRegisterClientIdListAction {
    type: ActionKeys.RemoveFromRegisterClientIdList;
    portalUrl: string;
}
export interface ActivePrintPreviewAction {
    type: ActionKeys.ActivePrintPreview;
}
export interface QuitPrintPreviewAction {
    type: ActionKeys.QuitPrintPreview;
}
export interface ExtensionRegisteredAction {
    type: ActionKeys.ExtensionRegistered;
...
export declare function addToRegisterClientIdList(portalUrl: string, needToSignIn?: boolean, serviceUrl?: string): AddToRegisterClientIdListAction;
...
export declare function extensionRegistered(epName: ExtensionPoints, extension: BaseExtension): ExtensionRegisteredAction;
export {};
