...
declare type DataRenderFunction = (dss: {
...
declare const _default: import("react-redux").ConnectedComponent<any, Omit<unknown, never> & MultipleDataSourceComponentProps & import("react-redux").ConnectProps>;
